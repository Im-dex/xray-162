...
#ifndef _oaRPCPipeTransport_h
#define _oaRPCPipeTransport_h
...
oaRPCTransportErrorType oaRPCInitPipeServerTransport(
  oaRPCTransport *transport,
  const char* pipename);

oaRPCTransportErrorType oaRPCInitPipeClientTransport(
  oaRPCTransport *transport,
  const char *pipename);
