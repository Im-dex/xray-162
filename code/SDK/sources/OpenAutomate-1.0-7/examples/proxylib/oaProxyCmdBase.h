...
#ifndef oaProxyCmdBase_h
#define oaProxyCmdBase_h
...
public:
  oaProxyCmdBase();
  virtual ~oaProxyCmdBase();

  // This is the main()  
  virtual void Run(void);

  void SetProxy(oaProxy *context);

    // Callback for get next option.
  virtual oaNamedOption* GetNextOption(void);

  protected:

  oaProxy *Proxy(void) { return(pProxy); }
