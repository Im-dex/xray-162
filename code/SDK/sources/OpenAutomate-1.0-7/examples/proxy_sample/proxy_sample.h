...
#ifndef Proxy_Sample_h
#define Proxy_Sample_h
...
class SampleProxy : public oaProxy
{
public:

  SampleProxy();
  SampleProxy(int port, const char* trace_file);
  ~SampleProxy();
...
private:
  ...
  SimpleAppSettings *pSettingsObj;

  std::string pClientApp;

};

class RunBenchmarkCmd : public oaProxyCmdBase
{
public:
  RunBenchmarkCmd( const oaChar *benchmark_name) {
