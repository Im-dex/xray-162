...
#define TEMPLATE_SPECIALIZATION                                                                   \
    template <typename _dist_type, typename _priority_queue, typename _vertex_manager,            \
              typename _vertex_allocator, bool euclidian_heuristics, typename _data_storage_base, \
              ...
              template <typename _algorithm, typename _manager, typename _builder,                \
...
#define CSDijkstra                                                                               \
    CDijkstra<_dist_type, _priority_queue, _vertex_manager, _vertex_allocator,                   \
              euclidian_heuristics, _data_storage_base, _vertex, _builder_allocator_constructor, \
