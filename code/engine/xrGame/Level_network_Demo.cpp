...
void CLevel::PrepareToSaveDemo() {
    ...
    SYSTEMTIME Time;
    GetLocalTime(&Time);
    xr_sprintf(demo_name, "xray_%02d-%02d-%02d_%02d-%02d-%02d.demo", Time.wMonth, Time.wDay,
...
void CLevel::SpawnDemoSpectator() { R_ASSERT2(false, "Multiplayer is unsupported"); }
