...
void RELATION_REGISTRY::FightRegister(u16 attacker, u16 defender,
                                      ALife::ERelationType defender_to_attacker, float hit_amount) {
    UpdateFightRegister();
...
bool fight_time_pred(RELATION_REGISTRY::FIGHT_DATA& fight_data) {
    ...
    static u32 fight_remember_time =
        u32(1000.f * pSettings->r_float(ACTIONS_POINTS_SECT, "fight_remember_time"));
