...
CEF_Storage::CEF_Storage() {
    ...
    m_fpaBaseFunctions[29] = m_pfPersonalAggressiveness =
        new CPersonalAggressivenessFunction(this);
    ...
    m_fpaBaseFunctions[50] = m_pfEnemyDistanceToGraphPoint =
        new CEnemyDistanceToGraphPoint(this);
    ...
    m_pfIntellectCreatureEffectiveness =
        new CPatternFunction("common\\IntCreatureEffectiveness.efd", this);
    m_pfAccuracyWeaponEffectiveness =
        new CPatternFunction("common\\AccWeaponEffectiveness.efd", this);
    m_pfFinalCreatureEffectiveness =
        new CPatternFunction("common\\FinCreatureEffectiveness.efd", this);
    ...
    m_pfWeaponSuccessProbability =
        new CPatternFunction("alife\\WeaponSuccessProbability.efd", this);
    m_pfEnemyDetectability = new CPatternFunction("alife\\EnemyDetectability.efd", this);
    m_pfEnemyDetectProbability =
        new CPatternFunction("alife\\EnemyDetectProbability.efd", this);
    m_pfEnemyRetreatProbability =
        new CPatternFunction("alife\\EnemyRetreatProbability.efd", this);
    m_pfAnomalyDetectProbability =
        new CPatternFunction("alife\\AnomalyDetectProbability.efd", this);
    m_pfAnomalyInteractProbability =
        new CPatternFunction("alife\\AnomalyInteractProbability.efd", this);
    m_pfAnomalyRetreatProbability =
        new CPatternFunction("alife\\AnomalyRetreatProbability.efd", this);
