...
void RELATION_REGISTRY::SetGoodwill(u16 from, u16 to, CHARACTER_GOODWILL goodwill) {
    ...
    static Ivector2 gw_limits =
        pSettings->r_ivector2(ACTIONS_POINTS_SECT, "personal_goodwill_limits");
...
void RELATION_REGISTRY::ForceSetGoodwill(u16 from, u16 to, CHARACTER_GOODWILL goodwill) {
    ...
    if (!from_obj || !to_obj) {
        ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
                                        "RELATION_REGISTRY::ForceSetGoodwill  : cannot convert obj "
                                        "to CSE_ALifeTraderAbstract!");
        return;
    }
    ...
    relation_data.personal[to].SetGoodwill(goodwill - community_to_obj_goodwill -
...
void RELATION_REGISTRY::SetCommunityGoodwill(CHARACTER_COMMUNITY_INDEX from_community,
                                             u16 to_character, CHARACTER_GOODWILL goodwill) {
    static Ivector2 gw_limits =
        pSettings->r_ivector2(ACTIONS_POINTS_SECT, "community_goodwill_limits");
    clamp(goodwill, gw_limits.x, gw_limits.y);
...
void RELATION_REGISTRY::ChangeCommunityGoodwill(CHARACTER_COMMUNITY_INDEX from_community,
                                                u16 to_character,
...
CHARACTER_GOODWILL RELATION_REGISTRY::GetRankRelation(CHARACTER_RANK_VALUE rank1,
