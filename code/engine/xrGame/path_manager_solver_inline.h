...
#define TEMPLATE_SPECIALIZATION                                                         \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, bool T6, \
              typename T7, typename T8, typename _DataStorage, typename _Parameters,    \
              typename _dist_type, typename _index_type, typename _iteration_type>

#define CSolverPathManager                                                                  \
    CPathManager<CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>, _DataStorage, _Parameters, \
...
TEMPLATE_SPECIALIZATION
IC void CSolverPathManager::setup(const _Graph* _graph, _DataStorage* _data_storage,
                                  std::vector<_edge_type>* _path,
...
TEMPLATE_SPECIALIZATION
IC const typename CSolverPathManager::_edge_type&
CSolverPathManager::edge(const_iterator& i) const {
