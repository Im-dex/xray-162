...
template <typename TIME_ID, typename TYPE_ID, typename VALUE_ID, typename BLOCK_ID,
          typename CHUNK_ID, VALUE_ID tMinValue, VALUE_ID tMaxValue, CHUNK_ID tBlockSize,
...
private:
    ...
    IC VALUE_ID tfGetFromBlock(SID_Block& l_tID_Block, VALUE_ID tValueID) {
        ...
        TYPE_ID* l_tpBlockID =
            std::find(l_tID_Block.m_tpIDs, l_tID_Block.m_tpIDs + l_tID_Block.m_tCount,
