...
void car_memory::camera(Fvector& position, Fvector& direction, Fvector& normal,
                        float& field_of_view, float& aspect_ratio, float& near_plane,
                        float& far_plane) {
...
void car_memory::set_camera(const Fvector& position, const Fvector& direction,
