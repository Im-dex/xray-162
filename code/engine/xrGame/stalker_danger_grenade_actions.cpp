...
CStalkerActionDangerGrenadeTakeCover::CStalkerActionDangerGrenadeTakeCover(CAI_Stalker* object,
                                                                           LPCSTR action_name)
...
CStalkerActionDangerGrenadeLookAround::CStalkerActionDangerGrenadeLookAround(CAI_Stalker* object,
                                                                             LPCSTR action_name)
    : inherited(object, action_name) {}
...
CStalkerActionDangerGrenadeSearch::CStalkerActionDangerGrenadeSearch(CAI_Stalker* object,
                                                                     LPCSTR action_name)
    : inherited(object, action_name) {}
