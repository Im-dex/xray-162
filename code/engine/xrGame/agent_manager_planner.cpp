...
void CAgentManagerPlanner::add_evaluators() {
    add_evaluator(ePropertyOrders,
                  xr_new<CAgentManagerPropertyEvaluatorConst>(false, "property_order"));
    add_evaluator(ePropertyItem,
                  xr_new<CAgentManagerPropertyEvaluatorItem>(&object(), "property_item"));
    add_evaluator(ePropertyEnemy,
                  xr_new<CAgentManagerPropertyEvaluatorEnemy>(&object(), "property_enemy"));
    add_evaluator(ePropertyDanger,
                  xr_new<CAgentManagerPropertyEvaluatorDanger>(&object(), "property_danger"));
}
