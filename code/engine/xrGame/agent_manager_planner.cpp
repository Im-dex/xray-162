...
void CAgentManagerPlanner::add_evaluators() {
    add_evaluator(ePropertyOrders,
                  new CAgentManagerPropertyEvaluatorConst(false, "property_order"));
    add_evaluator(ePropertyItem,
                  new CAgentManagerPropertyEvaluatorItem(&object(), "property_item"));
    add_evaluator(ePropertyEnemy,
                  new CAgentManagerPropertyEvaluatorEnemy(&object(), "property_enemy"));
    add_evaluator(ePropertyDanger,
                  new CAgentManagerPropertyEvaluatorDanger(&object(), "property_danger"));
}
