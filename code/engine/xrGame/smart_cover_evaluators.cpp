...
loophole_hit_long_ago_evaluator::loophole_hit_long_ago_evaluator(animation_planner* object,
...
is_action_available_evaluator::is_action_available_evaluator(animation_planner* object,
                                                             LPCSTR evaluator_name,
                                                             LPCSTR action_id)
...
_value_type is_action_available_evaluator::evaluate() {
    ...
    return (m_object->m_object->movement().current_params().cover_loophole()->is_action_available(
        m_action_id));
}
...
loophole_planner_const_evaluator::loophole_planner_const_evaluator(animation_planner* object,
                                                                   LPCSTR evaluator_name,
                                                                   bool const& value)
...
can_exit_loophole_with_animation::can_exit_loophole_with_animation(CAI_Stalker* object,
                                                                   LPCSTR evaluator_name)
    : inherited(object ? object->lua_game_object() : 0, evaluator_name) {}
...
default_behaviour_evaluator::default_behaviour_evaluator(animation_planner* object,
                                                         LPCSTR evaluator_name)
...
can_fire_at_enemy_evaluator::can_fire_at_enemy_evaluator(animation_planner* object,
                                                         LPCSTR evaluator_name)
    : inherited(object, evaluator_name) {}
...
idle_time_interval_passed_evaluator::idle_time_interval_passed_evaluator(animation_planner* object,
                                                                         LPCSTR evaluator_name,
