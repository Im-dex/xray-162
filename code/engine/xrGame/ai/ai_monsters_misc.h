...
#define WRITE_TO_LOG(S)                                                                    \
    {                                                                                      \
        Msg("%s,%s,%d,p[%.2f,%.2f,%.2f],%.2f,h[%.2f,%.2f],t[%.2f,%.2f]", *cName(), S,      \
            Device.dwTimeGlobal, Position().x, Position().y, Position().z, m_fCurSpeed,    \
...
extern u32 dwfChooseAction(u32 dwActionRefreshRate, float fMinProbability0, float fMinProbability1,
                           ...
                           u32 dwGroup, u32 a0, u32 a1, u32 a2, u32 a3, u32 a4,
                           CEntity* tpEntity = 0, float fGroupDistance = 100.f);
