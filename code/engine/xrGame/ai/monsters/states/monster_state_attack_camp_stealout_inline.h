...
CStateMonsterAttackCampStealOutAbstract::CStateMonsterAttackCampStealOut(_Object* obj)
    : inherited(obj) {}
...
bool CStateMonsterAttackCampStealOutAbstract::check_completion() {
    ...
    Fvector pos =
        ai().level_graph().vertex_position(this->object->EnemyMan.get_my_vertex_enemy_last_seen());
