...
bool CStateMonsterAttackCampAbstract::check_start_conditions() {
    ...
    if (this->object->Position().distance_to(this->object->EnemyMan.get_enemy_position()) <
    ...
    const CCoverPoint* point =
        this->object->CoverMan->find_cover(this->object->EnemyMan.get_enemy_position(), 10.f, 30.f);
    if (!point)
        return false;
