...
CStateMonsterSmartTerrainTaskAbstract::CStateMonsterSmartTerrainTask(_Object* obj)
    : inherited(obj) {
    this->add_state(eStateSmartTerrainTaskGamePathWalk,
                    new CStateMonsterSmartTerrainTaskGraphWalk<_Object>(obj));
    this->add_state(eStateSmartTerrainTaskLevelPathWalk,
                    new CStateMonsterMoveToPointEx<_Object>(obj));
