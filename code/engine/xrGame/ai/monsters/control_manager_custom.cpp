...
//////////////////////////////////////////////////////////////////////////
void CControlManagerCustom::ta_fill_data(SAnimationTripleData& data, LPCSTR s1, LPCSTR s2,
                                         LPCSTR s3, bool execute_once, bool skip_prep,
                                         u32 capture_type) {
...
void CControlManagerCustom::ta_activate(const SAnimationTripleData& data) {
    ...
    SAnimationTripleData* ctrl_data =
        (SAnimationTripleData*)m_man->data(this, ControlCom::eControlTripleAnimation);
    VERIFY(ctrl_data);
...
void CControlManagerCustom::seq_init() {
    ...
    SAnimationSequencerData* ctrl_data =
        (SAnimationSequencerData*)m_man->data(this, ControlCom::eControlSequencer);
    if (!ctrl_data)
        return;
...
void CControlManagerCustom::load_jump_data(LPCSTR s1, LPCSTR s2, LPCSTR s3, LPCSTR s4,
                                           u32 vel_mask_prepare, u32 vel_mask_ground, u32 flags) {
    IKinematicsAnimated* skel_animated = smart_cast<IKinematicsAnimated*>(m_object->Visual());
    if (!skel_animated) {
...
bool CControlManagerCustom::jump_if_possible(Fvector const& target,
    ...
    bool const aggressive_jump =
        target_object ? m_object->can_use_agressive_jump(target_object) : NULL;
...
void CControlManagerCustom::add_rotation_jump_data(LPCSTR left1, LPCSTR left2, LPCSTR right1,
                                                   LPCSTR right2, float angle, u32 flags) {
...
void CControlManagerCustom::check_threaten() {
    ...
    SControlThreatenData* ctrl_data =
        (SControlThreatenData*)m_man->data(this, ControlCom::eControlThreaten);
    VERIFY(ctrl_data);
...
void CControlManagerCustom::check_melee_jump() {
    ...
    SControlMeleeJumpData* ctrl_data =
        (SControlMeleeJumpData*)m_man->data(this, ControlCom::eControlMeleeJump);
    VERIFY(ctrl_data);
...
// Fill Rotation Data
//////////////////////////////////////////////////////////////////////////
void CControlManagerCustom::fill_rotation_data(SControlRotationJumpData& data, LPCSTR left1,
                                               LPCSTR left2, LPCSTR right1, LPCSTR right2,
