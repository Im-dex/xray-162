...
public:
    ...
    void LinkAction(EAction act, EMotionAnim pmt_motion, EMotionAnim pmt_left,
...
public:
    ...
    bool accel_chain_get(float cur_speed, EMotionAnim target_anim, EMotionAnim& new_anim,
                         float& a_speed);
