...
CStateManagerBloodsucker::CStateManagerBloodsucker(CAI_Bloodsucker* monster) : inherited(monster) {
    ...
    // add_state(eStateAttack,				new CBloodsuckerStateAttack<CAI_Bloodsucker >
    // (monster));

    add_state(eStateEat, new CStateMonsterEat<CAI_Bloodsucker>(monster));
    add_state(eStateHearInterestingSound,
              new CStateMonsterHearInterestingSound<CAI_Bloodsucker>(monster));
    add_state(eStateHearDangerousSound,
              new CStateMonsterHearDangerousSound<CAI_Bloodsucker>(monster));
    add_state(eStateHitted, new CStateMonsterHitted<CAI_Bloodsucker>(monster));
    add_state(eStateVampire_Execute,
              new CStateBloodsuckerVampireExecute<CAI_Bloodsucker>(monster));
}
