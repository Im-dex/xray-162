...
CAlienEffector::CAlienEffector(ECamEffectorType type, CAI_Bloodsucker* obj)
    ...
    Fvector::generate_orthonormal_basis(m_prev_eye_matrix.k, m_prev_eye_matrix.j,
                                        m_prev_eye_matrix.i);
    m_inertion = 1.f;
...
BOOL CAlienEffector::ProcessCam(SCamEffectorInfo& info) {
    ...
    Fvector::generate_orthonormal_basis_normalized(m_prev_eye_matrix.k, m_prev_eye_matrix.j,
                                                   m_prev_eye_matrix.i);
...
void CBloodsuckerAlien::activate() {
    ...
    // Start effector
    m_effector_pp =
        xr_new<CAlienEffectorPP>(m_object->pp_vampire_effector, EFFECTOR_ID_GEN(EEffectorPPType));
