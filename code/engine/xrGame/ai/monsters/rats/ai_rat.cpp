...
CAI_Rat::CAI_Rat() : m_behaviour_manager(0) {
    ...
    //	m_behaviour_manager->add		(new steering_behaviour::cohesion(this),
    //.5f);
    //	m_behaviour_manager->add		(new steering_behaviour::separation(this),
    //.5f);
    //	m_behaviour_manager->add		(new steering_behaviour::alignment(this),
    //.5f);
}
