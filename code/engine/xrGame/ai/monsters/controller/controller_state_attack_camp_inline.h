...
void CStateControlCampAbstract::initialize() {
    ...
    float angle = ai().level_graph().vertex_low_cover_angle(object->ai_location().level_vertex_id(),
...
void CStateControlCampAbstract::execute() {
    ...
    object->custom_anim().set_body_state(CControllerAnimation::eTorsoIdle,
