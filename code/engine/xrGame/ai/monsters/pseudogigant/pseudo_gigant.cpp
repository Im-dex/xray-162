...
void CPseudoGigant::Load(LPCSTR section) {
    ...
    anim().AddAnim(eAnimWalkDamaged, "stand_walk_fwd_dmg_", -1, &velocity_walk_dmg, PS_STAND,
                   "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimRun, "stand_walk_fwd_", -1, &velocity_walk, PS_STAND, "fx_stand_f",
                   "fx_stand_b", "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimRunDamaged, "stand_walk_fwd_dmg_", -1, &velocity_walk_dmg, PS_STAND,
                   "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimEat, "stand_eat_", -1, &velocity_none, PS_STAND, "fx_stand_f", "fx_stand_b",
                   "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimAttack, "stand_attack_", -1, &velocity_none, PS_STAND, "fx_stand_f",
                   "fx_stand_b", "fx_stand_l", "fx_stand_r");
    ...
    // anim().AddAnim(eAnimStandIdle,		"stand_idle_",			-1, &velocity_none,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimStandTurnLeft,
    // "stand_turn_ls_",		-1, &velocity_turn,		PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimStandTurnRight,	"stand_turn_rs_",
    // -1, &velocity_turn,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimLieIdle,		"stand_sleep_",			-1, &velocity_none,		PS_LIE,		"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimSitIdle,
    // "sit_idle_",			-1, &velocity_none,		PS_SIT,		"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimSleep,			"stand_sleep_",			-1, &velocity_none,		PS_LIE,		"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimWalkFwd,
    // "stand_walk_fwd_",		-1, &velocity_walk,		PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimWalkDamaged,	"stand_walk_fwd_dmg_",
    // -1, &velocity_walk_dmg,	PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimRun,			"stand_run_fwd_",		-1,	&velocity_run,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimRunDamaged,
    // "stand_run_dmg_",		-1,	&velocity_run_dmg,	PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimEat,			"stand_eat_",
    // -1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimAttack,			"stand_attack_",		-1, &velocity_turn,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimLookAround,
    // "stand_idle_",			-1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimSteal,			"stand_steal_",
    // -1, &velocity_steal,	PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimDie,			"stand_idle_",			-1, &velocity_none,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimStandLieDown,
    // "stand_lie_down_",		-1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r");  anim().AddAnim(eAnimLieToSleep,		"lie_to_sleep_",
    // -1, &velocity_none,		PS_LIE,		"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimThreaten,		"stand_kick_",			-1, &velocity_none,		PS_STAND,	"fx_stand_f",
    // "fx_stand_b", "fx_stand_l", "fx_stand_r");

    // 	anim().AddAnim(eAnimRunTurnLeft,	"stand_run_left_",		-1, &velocity_run,
    // PS_STAND); 	anim().AddAnim(eAnimRunTurnRight,	"stand_run_right_",		-1,
    ...
    sscanf(pSettings->r_string(ppi_section, "color_base"), "%f,%f,%f",
           &m_threaten_effector.ppi.color_base.r, &m_threaten_effector.ppi.color_base.g,
           &m_threaten_effector.ppi.color_base.b);
    sscanf(pSettings->r_string(ppi_section, "color_gray"), "%f,%f,%f",
           &m_threaten_effector.ppi.color_gray.r, &m_threaten_effector.ppi.color_gray.g,
           &m_threaten_effector.ppi.color_gray.b);
    sscanf(pSettings->r_string(ppi_section, "color_add"), "%f,%f,%f",
           &m_threaten_effector.ppi.color_add.r, &m_threaten_effector.ppi.color_add.g,
    ...
    ::Sound->create(m_sound_threaten_hit, pSettings->r_string(section, "sound_threaten_hit"),
                    st_Effect, SOUND_TYPE_WORLD);
    ::Sound->create(m_sound_start_threaten, pSettings->r_string(section, "sound_threaten_start"),
...
void CPseudoGigant::on_threaten_execute() {
    ...
    Actor()->Cameras().AddCamEffector(xr_new<CMonsterEffectorHit>(
        m_threaten_effector.ce_time, m_threaten_effector.ce_amplitude * hit_value,
    ...
    HS.boneID =
        (smart_cast<IKinematics*>(pA->Visual())
             ->LL_GetBoneRoot()); //	l_P.w_s16
                                  //(smart_cast<IKinematics*>(pA->Visual())->LL_GetBoneRoot());
    HS.p_in_bone_space =
        (Fvector().set(0.f, 0.f, 0.f)); //	l_P.w_vec3	(Fvector().set(0.f,0.f,0.f));
    HS.impulse =
        (80 * pA->character_physics_support()
                  ->movement()
