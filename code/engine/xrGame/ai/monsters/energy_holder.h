...
class CEnergyHolder {
    ...
    float m_critical_value;         // критическое значение энергии, меньше которого активность будет
                                    // отключена (ltx-param)
    float m_activate_value;         // значение энергии, больше которого активность может быть восстановлена
                                    // (ltx-param)
