...
void monster_aura::load_from_ini(CInifile const* ini, pcstr const section,
    ...
    m_enable_for_dead =
        !!READ_IF_EXISTS(ini, r_bool, section, enable_for_dead_string, enable_for_dead_default);
