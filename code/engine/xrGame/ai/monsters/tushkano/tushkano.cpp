...
void CTushkano::Load(LPCSTR section) {
    ...
    // anim().AddAnim(eAnimWalkDamaged,		"stand_walk_fwd_dmg_",	-1, &velocity_walk_dmg,
    // PS_STAND);
    ...
    // anim().AddAnim(eAnimDie,				"stand_die_",			0,  &velocity_none,
    // PS_STAND);  anim().AddAnim(eAnimCheckCorpse,		"stand_check_corpse_",	-1,
    // &velocity_none,				PS_STAND);  anim().AddAnim(eAnimSteal,
    // "stand_crawl_",			-1, &velocity_steal,			PS_STAND);
    ...
    // PS_STAND);  anim().AddAnim(eAnimLookAround,		"stand_look_around_",	-1,
    // &velocity_none,				PS_STAND);  anim().AddAnim(eAnimEat,
    // "sit_eat_",				-1, &velocity_none,
    // PS_SIT);
