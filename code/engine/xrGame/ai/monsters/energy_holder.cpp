...
void CEnergyHolder::reload(LPCSTR section, LPCSTR prefix, LPCSTR suffix) {
    ...
    m_restore_vel = pSettings->r_float(section, strconcat(sizeof(line_name), line_name, prefix,
                                                          "Energy_Restore_Velocity", suffix));
    m_decline_vel = pSettings->r_float(section, strconcat(sizeof(line_name), line_name, prefix,
    ...
    m_aggressive_restore_vel =
        pSettings->r_float(section, strconcat(sizeof(line_name), line_name, prefix,
