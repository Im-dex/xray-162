...
CStateManagerPoltergeist::CStateManagerPoltergeist(CPoltergeist* obj) : inherited(obj) {
    ...
    add_state(eStateHearInterestingSound,
              new CStateMonsterHearInterestingSound<CPoltergeist>(obj));
...
void CStateManagerPoltergeist::polter_attack() {
    ...
    // if ((time_next_flame_attack < cur_time) && (object->EnemyMan.get_enemy_time_last_seen() +
    // TIME_SEEN_FOR_FIRE > cur_time)) {
    //
