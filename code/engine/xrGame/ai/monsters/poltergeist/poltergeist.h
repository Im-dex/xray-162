...
public:
    ...
    const char* get_monster_class_name() override { return "poltergeist"; }
...
class CPolterTele : public CPolterSpecialAbility {
    ...
    enum ETeleState { eStartRaiseObjects, eRaisingObjects, eFireObjects, eWait } m_state;
...
private:
    void tele_find_objects(std::vector<CObject*>& objects, const Fvector& pos);
