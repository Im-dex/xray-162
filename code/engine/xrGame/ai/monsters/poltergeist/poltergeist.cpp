...
void CPoltergeist::Load(LPCSTR section) {
    ...
    anim().AddAnim(eAnimAttack, "stand_attack_", -1, &velocity_turn, PS_STAND, "fx_stand_f",
                   "fx_stand_b", "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimDie, "stand_idle_", 0, &velocity_none, PS_STAND, "fx_stand_f", "fx_stand_b",
                   "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimMiscAction_00, "fall_down_", -1, &velocity_none, PS_STAND, "fx_stand_f",
                   "fx_stand_b", "fx_stand_l", "fx_stand_r");
    anim().AddAnim(eAnimMiscAction_01, "fly_", -1, &velocity_none, PS_STAND, "fx_stand_f",
                   "fx_stand_b", "fx_stand_l", "fx_stand_r");
    ...
    m_height_change_velocity =
        READ_IF_EXISTS(pSettings, r_float, section, "Height_Change_Velocity", 0.5f);
    m_height_change_min_time =
        READ_IF_EXISTS(pSettings, r_u32, section, "Height_Change_Min_Time", 3000);
    m_height_change_max_time =
        READ_IF_EXISTS(pSettings, r_u32, section, "Height_Change_Max_Time", 10000);
    ...
    m_fly_around_level =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_fly_around_level", 5.f);
    m_fly_around_distance =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_fly_around_distance", 15.f);

    m_fly_around_change_direction_time = READ_IF_EXISTS(
        pSettings, r_float, section, "detection_fly_around_change_direction_time", 7);
    ...
    m_detection_pp_effector_name =
        READ_IF_EXISTS(pSettings, r_string, section, "detection_pp_effector_name", "");
    m_detection_near_range_factor =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_near_range_factor", 2.f);
    m_detection_far_range_factor =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_far_range_factor", 1.f);
    m_detection_speed_factor =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_speed_factor", 1.f);
    m_detection_loose_speed =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_loose_speed", 5.f);
    m_detection_far_range =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_far_range", 20.f);
    m_detection_success_level =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_success_level", 4.f);
    m_detection_max_level =
        READ_IF_EXISTS(pSettings, r_float, section, "detection_max_level", 100.f);
...
void CPoltergeist::update_detection() {
    ...
    if (!get_actor_ignore() && time_passed_sec > 0.f && time_passed_sec < 2.f &&
...
void CPoltergeist::UpdateHeight() {
    ...
    if (time_height_updated < cur_time) {
        time_height_updated =
            cur_time + Random.randI(m_height_change_min_time, m_height_change_max_time);
