...
private:
    struct CTradeItem {
        ...
        IC CTradeItem(CInventoryItem* item, ALife::_OBJECT_ID owner_id,
...
protected:
    ...
    bool conflicted(const CInventoryItem* item, const CWeapon* new_weapon,
                    bool new_wepon_enough_ammo, int new_weapon_rank) const;
...
private:
    bool throw_check_error(float low, float high, const Fvector& start, const Fvector& velocity,
