...
void CAI_Stalker::LoadSounds(LPCSTR section) {
    ...
    sound().add(pSettings->r_string(section, "sound_friendly_fire"), 100,
                ...
                eStalkerSoundInjuringByFriend, head_bone_name, new CStalkerSoundData(this));
    ...
    sound().add(pSettings->r_string(section, "sound_panic_monster"), 100,
                ...
                eStalkerSoundPanicMonster, head_bone_name, new CStalkerSoundData(this));
    sound().add(pSettings->r_string(section, "sound_grenade_alarm"), 100,
                ...
                eStalkerSoundGrenadeAlarm, head_bone_name, new CStalkerSoundData(this));
    sound().add(pSettings->r_string(section, "sound_friendly_grenade_alarm"), 100,
                ...
                eStalkerSoundFriendlyGrenadeAlarm, head_bone_name, new CStalkerSoundData(this));
    ...
    sound().add(pSettings->r_string(section, "sound_attack_no_allies"), 100,
                ...
                eStalkerSoundAttackNoAllies, head_bone_name, new CStalkerSoundData(this));
    ...
    sound().add(pSettings->r_string(section, "sound_search1_no_allies"), 100,
                ...
                eStalkerSoundSearch1NoAllies, head_bone_name, new CStalkerSoundData(this));
    sound().add(pSettings->r_string(section, "sound_search1_with_allies"), 100,
                ...
                eStalkerSoundSearch1WithAllies, head_bone_name, new CStalkerSoundData(this));
    sound().add(pSettings->r_string(section, "sound_enemy_lost_no_allies"), 100,
                ...
                eStalkerSoundEnemyLostNoAllies, head_bone_name, new CStalkerSoundData(this));
    sound().add(pSettings->r_string(section, "sound_enemy_lost_with_allies"), 100,
                ...
                eStalkerSoundEnemyLostWithAllies, head_bone_name, new CStalkerSoundData(this));
    ...
    sound().add(pSettings->r_string(section, "sound_running_in_danger"), 100,
                ...
                eStalkerSoundRunningInDanger, head_bone_name, new CStalkerSoundData(this));
    ...
    sound().add(pSettings->r_string(section, "sound_enemy_killed_or_wounded"), 100,
                ...
                eStalkerSoundEnemyKilledOrWounded, head_bone_name, new CStalkerSoundData(this));
    sound().add(pSettings->r_string(section, "sound_throw_grenade"), 100,
                ...
                eStalkerSoundThrowGrenade, head_bone_name, new CStalkerSoundData(this));
}
...
DLL_Pure* CAI_Stalker::_construct() {
    m_pPhysics_support =
        new CCharacterPhysicsSupport(CCharacterPhysicsSupport::etStalker, this);
