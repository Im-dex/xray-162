...
public:
    ...
    IC void add_condition(CSActionBase* action, u16 id, EWorldProperties property,
                          _value_type value);
...
public:
    ...
    void set_goal(EObjectAction object_action, CGameObject* game_object, u32 min_queue_size,
