...
template <typename _data_type = imdex::empty, typename _edge_weight_type = float,
          typename _vertex_id_type = u32, typename _edge_data_type = imdex::empty>
...
public:
    ...
    IC const _edge_weight_type get_edge_weight(const _vertex_id_type vertex_index0,
