...
void CStalkerDangerPlanner::add_evaluators() {
    ...
    add_evaluator(eWorldPropertyDangerUnknown,
                  new CStalkerPropertyEvaluatorDangerUnknown(m_object, "danger unknown"));
    add_evaluator(
        eWorldPropertyDangerInDirection,
        new CStalkerPropertyEvaluatorDangerInDirection(m_object, "danger in direction"));
    add_evaluator(eWorldPropertyDangerGrenade, new CStalkerPropertyEvaluatorDangerWithGrenade(
                                                   m_object, "danger with grenade"));
    add_evaluator(eWorldPropertyDangerBySound,
                  new CStalkerPropertyEvaluatorDangerBySound(m_object, "danger by sound"));
}
