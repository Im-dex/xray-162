...
public:
    ...
    virtual BOOL OnTouch(u16 eid_who, u16 eid_target,
    ...
    virtual void OnPlayerHitPlayer(u16 id_hitter, u16 id_hitted,
    ...
    // this method will delete all events for entity that already not exist (in case when player was
    // kicked)
    ...
    static std::string parse_level_name(const shared_str& server_options);
