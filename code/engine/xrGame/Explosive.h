...
public:
    ...
    static float ExplosionEffect(collide::rq_results& storage, CExplosive* exp_obj,
...
private:
    ...
    static float TestPassEffect(const Fvector& source_p, const Fvector& dir, float range,
...
protected:
    ...
    //Время, через которое надо сделать взрывчатку невиимой, если она не становится невидимой во
    //время взрыва
