...
CStalkerActionDangerUnknownTakeCover::CStalkerActionDangerUnknownTakeCover(CAI_Stalker* object,
                                                                           LPCSTR action_name)
...
CStalkerActionDangerUnknownLookAround::CStalkerActionDangerUnknownLookAround(CAI_Stalker* object,
                                                                             LPCSTR action_name)
    : inherited(object, action_name) {}
...
CStalkerActionDangerUnknownSearch::CStalkerActionDangerUnknownSearch(CAI_Stalker* object,
                                                                     LPCSTR action_name)
    : inherited(object, action_name) {}
...
void CStalkerActionDangerUnknownSearch::execute() {
    ...
    if (object().agent_manager().member().member(&object()).cover()) {
        object().agent_manager().location().add(xr_new<CDangerCoverLocation>(
            object().agent_manager().member().member(&object()).cover(), Device.dwTimeGlobal,
