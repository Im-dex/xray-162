...
class CALifeCombatManager : public virtual CALifeSimulatorBase, CRandom {
    ...
    protected:
                            void					vfFillCombatGroup
    (CSE_ALifeSchedulable		*tpALifeSchedulable,		int
    iGroupIndex); bool					bfCheckObjectDetection
    (CSE_ALifeSchedulable		*tpALifeSchedulable1,		CSE_ALifeSchedulable
    *tpALifeSchedulable2); bool					bfCheckForInteraction
    (CSE_ALifeSchedulable		*tpALifeSchedulable1,		CSE_ALifeSchedulable
    *tpALifeSchedulable2,			int				&iCombatGroupIndex,			bool
    &bMutualDetection); void					vfPerformAttackAction
    (int						iCombatGroupIndex); bool
...
public:
    ...
    (); IC		ALife::ECombatType		combat_type
    () const; ALife::ECombatAction	choose_combat_action		(int
