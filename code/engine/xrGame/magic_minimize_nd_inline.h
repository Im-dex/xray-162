...
TEMPLATE_SPECIALIZATION
_MinimizeND::MinimizeND(Function oF, int iMaxLevel, int iMaxBracket, int iMaxIterations,
                        void* pvUserData)
...
TEMPLATE_SPECIALIZATION
void _MinimizeND::GetMinimum(const float* afT0, const float* afT1, const float* afTInitial,
                             float* afTMin, float& rfFMin) {
