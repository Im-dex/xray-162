...
public:
    ...
    loophole* best_loophole(Fvector const& position, float& value,
                            bool const& use_default_behaviour, bool is_smart_cover_entered) const;
    IC DescriptionPtr const& description() const;
    void evaluate_loophole(Fvector const& position, loophole*& source, loophole*& result,
                           float& value, bool is_smart_cover_entered) const;
    ...
    bool in_min_acceptable_range(loophole const& source, Fvector const& position,
