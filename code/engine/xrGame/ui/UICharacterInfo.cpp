...
void CUICharacterInfo::InitCharacter(u16 id) {
    ...
    /*
            ...
            {
                    if ( m_icons[eCommunityIcon   ] ) { m_icons[eCommunityIcon   ]->InitTexture(
       community1 ); } if ( m_icons[eCommunityBigIcon] ) { m_icons[eCommunityBigIcon]->InitTexture(
       community2 ); } return;
            }
...
namespace detail { // helper function implemented in file alife_simulator.cpp
