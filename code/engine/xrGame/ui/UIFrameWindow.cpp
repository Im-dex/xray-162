...
void CUIFrameWindow::InitTextureEx(LPCSTR texture, LPCSTR sh_name) {
    ...
    string256 buf;
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_back"), sh_name, m_shader,
                                  m_tex_rect[fmBK]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_l"), sh_name, m_shader,
                                  m_tex_rect[fmL]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_r"), sh_name, m_shader,
                                  m_tex_rect[fmR]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_t"), sh_name, m_shader,
                                  m_tex_rect[fmT]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_b"), sh_name, m_shader,
                                  m_tex_rect[fmB]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_lt"), sh_name, m_shader,
                                  m_tex_rect[fmLT]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_rb"), sh_name, m_shader,
                                  m_tex_rect[fmRB]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_rt"), sh_name, m_shader,
                                  m_tex_rect[fmRT]);
    CUITextureMaster::InitTexture(strconcat(sizeof(buf), buf, texture, "_lb"), sh_name, m_shader,
                                  m_tex_rect[fmLB]);
...
bool CUIFrameWindow::get_points(Frect const& r, int i, Fvector2& LTp, Fvector2& RBp, Fvector2& LTt,
                                Fvector2& RBt) {
    LTt = m_tex_rect[i].lt;
    RBt = m_tex_rect[i].rb;
