...
void CUIStalkersRankingWnd::Init() {
    ...
    UICharacterInfo->InitCharacterInfo(Fvector2().set(0, 0), UICharacterWindow->GetWndSize(),
...
int get_actor_ranking() {
    ...
    TOP_LIST::iterator it =
        std::find(g_all_statistic_humans.begin(), g_all_statistic_humans.end(), d);
...
void CUIStalkersRankingWnd::Reset() { inherited::Reset(); }
