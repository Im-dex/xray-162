...
FractionState::FractionState()
    : member_count(0), resource(0.0f), power(0.0f), state_vs(0), m_actor_goodwill(0) {
    m_id._set(NULL);
    m_name._set(NULL);
    m_icon._set(NULL);
...
void FractionState::script_register(lua_State* L) {
    module(L)[class_<FractionState>("FractionState")
                  ...
                  .property("fraction_id", &FractionState::get_fraction_id,
                            &FractionState::set_fraction_id)
                  .property("actor_goodwill", &FractionState::get_actor_goodwill,
                            &FractionState::set_actor_goodwill)
                  ...
                  .property("target_desc", &FractionState::get_target_desc,
                            &FractionState::set_target_desc)
...
void FractionState::update_info() {
    ...
    if (pActor) {
        ...
        char_ñmm.set(m_id);
        m_actor_goodwill =
            RELATION_REGISTRY().GetCommunityGoodwill(char_ñmm.index(), pActor->object_id());
    }
