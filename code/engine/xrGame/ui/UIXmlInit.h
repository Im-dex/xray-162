...
public:
    ...
    static bool InitDragDropListEx(CUIXml& xml_doc, LPCSTR path, int index,
    ...
    static bool InitAnimatedStatic(CUIXml& xml_doc, LPCSTR path, int index,
...
public:
    static bool InitAlignment(CUIXml& xml_doc, const char* path, int index, float& x, float& y,
                              CUIWindow* pWnd);

    static void InitAutoStaticGroup(CUIXml& xml_doc, LPCSTR path, int index, CUIWindow* pParentWnd);
    static void InitAutoFrameLineGroup(CUIXml& xml_doc, LPCSTR path, int index,
