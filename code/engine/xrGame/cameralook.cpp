...
void CCameraLook2::UpdateAutoAim() {
    ...
    yaw = angle_inertion_var(yaw, xyz.y, m_autoaim_inertion_yaw.x, m_autoaim_inertion_yaw.y, PI,
                             Device.fTimeDelta);

    pitch = angle_inertion_var(pitch, xyz.x, m_autoaim_inertion_pitch.x, m_autoaim_inertion_pitch.y,
                               PI, Device.fTimeDelta);
}
