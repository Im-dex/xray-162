...
public:
    ...
    void SetPointLookAngles(const Fvector& tPosition, float& yaw, float& pitch,
                            Fvector const& look_position, const CGameObject* object = 0);
    ...
    void SetLessCoverLook(const LevelGraph::CVertex* tpNode, float fMaxHeadTurnAngle,
...
public:
    IC void bone_aiming();
    IC void bone_aiming(shared_str const& animation_id, animation_frame_type const animation_frame,
