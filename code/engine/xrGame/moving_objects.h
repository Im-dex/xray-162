...
private:
    ...
    typedef std::vector<CObject*> NEAREST_STATIC;
...
private:
    IC MagicBox3& continuous_box(moving_object* object0, const Fvector& position0,
                                 MagicBox3& result, const bool& use_box_enlargement) const;
    ...
    void resolve_collision_first(boxes& current, moving_object* object0, moving_object* object1,
                                 possible_actions& action) const;
    void resolve_collision(boxes& current, moving_object* object0, const Fvector& position0,
    ...
    bool fill_collisions(moving_object* object, const Fvector& object_position,
...
public:
    ...
    void query_action_static(moving_object* object, const Fvector& start_position,
