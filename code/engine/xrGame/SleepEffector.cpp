...
// CMonsterEffector
//////////////////////////////////////////////////////////////////////////
CSleepEffectorPP::CSleepEffectorPP(const SPPInfo& ppi, float life_time, float attack_time,
                                   float release_time)
...
BOOL CSleepEffectorPP::Process(SPPInfo& pp) {
    ...
    if (time_past_perc < m_attack) {
        ...
        m_eSleepState = BEGIN_SLEEP;
    } else if (BEGIN_SLEEP == m_eSleepState && (time_past_perc >= m_attack) &&
    ...
    pp.noise.intensity =
        def.noise.intensity + (state.noise.intensity - def.noise.intensity) * factor;
