...
private:
    ...
    void process_query(CPHMovementControl* movement_control, Fvector& dest_position,
                       float time_delta);
    void move_along_path_impl(CPHMovementControl* movement_control, Fvector& dest_position,
                              float time_delta);
