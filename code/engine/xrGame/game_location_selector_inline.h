...
IC CGameLocationSelector::CBaseLocationSelector(CRestrictedObject* object,
...
TEMPLATE_SPECIALIZATION
IC void CGameLocationSelector::select_location(const _vertex_id_type start_vertex_id,
