...
void CMemoryInfo::script_register(lua_State* L) {
    module(L)[
        ...
        class_<MemorySpace::CMemoryObject<CEntityAlive>, MemorySpace::SMemoryObject>(
        ...
        class_<MemorySpace::CMemoryObject<CGameObject>, MemorySpace::SMemoryObject>(
            "game_memory_object")
        ...
        class_<MemorySpace::CHitObject, MemorySpace::CMemoryObject<CEntityAlive>>(
            "hit_memory_object")
        ...
        class_<MemorySpace::CVisibleObject, MemorySpace::CMemoryObject<CGameObject>>(
        ...
        class_<MemorySpace::CSoundObject, MemorySpace::CMemoryObject<CGameObject>>(
            "sound_memory_object")
        ...
        class_<CDangerObject>("danger_object")
            .enum_(
                "danger_type")[value("bullet_ricochet", CDangerObject::eDangerTypeBulletRicochet),
            ...
            .enum_(
                "danger_perceive_type")[value("visual", CDangerObject::eDangerPerceiveTypeVisual),
