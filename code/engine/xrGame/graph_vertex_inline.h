...
IC CSGraphVertex::CVertex(const _data_type& data, const _vertex_id_type& vertex_id,
                          size_t* edge_count) {
    m_data = data;
...
TEMPLATE_SPECIALIZATION
IC const typename CSGraphVertex::_edge_type*
CSGraphVertex::edge(const _vertex_id_type& vertex_id) const {
