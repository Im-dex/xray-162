...
public:
    CScriptPropertyEvaluatorWrapper(CScriptGameObject* object = 0, LPCSTR evaluator_name = "")
        : CScriptPropertyEvaluator(object, evaluator_name) {}
    virtual void setup(CScriptGameObject* object, CPropertyStorage* storage);
    static void setup_static(CScriptPropertyEvaluator* evaluator, CScriptGameObject* object,
