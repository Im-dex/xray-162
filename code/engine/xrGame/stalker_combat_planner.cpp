...
void CStalkerCombatPlanner::add_evaluators() {
    add_evaluator(eWorldPropertyPureEnemy,
                  xr_new<CStalkerPropertyEvaluatorEnemies>(m_object, "is_there_enemies", 0));
    ...
    add_evaluator(eWorldPropertyEnemySeeMe,
                  xr_new<CStalkerPropertyEvaluatorEnemySeeMe>(m_object, "enemy see me"));
    add_evaluator(eWorldPropertyItemToKill,
                  xr_new<CStalkerPropertyEvaluatorItemToKill>(m_object, "item to kill"));
    add_evaluator(eWorldPropertyItemCanKill,
                  xr_new<CStalkerPropertyEvaluatorItemCanKill>(m_object, "item can kill"));
    ...
    add_evaluator(eWorldPropertyFoundAmmo,
                  xr_new<CStalkerPropertyEvaluatorFoundAmmo>(m_object, "found ammo"));
    add_evaluator(eWorldPropertyReadyToKill,
                  xr_new<CStalkerPropertyEvaluatorReadyToKill>(m_object, "ready to kill"));
    ...
    add_evaluator(eWorldPropertyDangerGrenade, xr_new<CStalkerPropertyEvaluatorGrenadeToExplode>(
    ...
    add_evaluator(eWorldPropertyLowCover,
                  xr_new<CStalkerPropertyEvaluatorLowCover>(m_object, "using low cover"));
...
void CStalkerCombatPlanner::add_actions() {
...

    {
        CStalkerKillWoundedPlanner* planner =
            xr_new<CStalkerKillWoundedPlanner>(m_object, "kill wounded enemy");
