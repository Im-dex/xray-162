...
void CScriptActionWrapper::setup_static(CScriptActionBase* action, CScriptGameObject* object,
...
// CScriptActionWrapper::_edge_value_type CScriptActionWrapper::weight	(const CSConditionState
// &condition0, const CSConditionState &condition1) const
//{
...
//		ai().script_engine().script_log	(eLuaMessageTypeError,"Weight is less than effect
//count! It is corrected from %d to %d",_weight,min_weight());
//		_weight							= min_weight();
//	}
//	return								(_weight);
//}
//
// CScriptActionWrapper::_edge_value_type CScriptActionWrapper::weight_static	(CScriptActionBase
// *action, const CSConditionState &condition0, const CSConditionState &condition1)
//{
//	return								(((const
