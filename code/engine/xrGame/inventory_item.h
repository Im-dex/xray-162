...
public:
    ...
    float interpolate_states(net_update_IItem const& first, net_update_IItem const& last,
                             SPHNetState& current);
...
protected:
    ...
    template <typename T>
    IC static bool process_if_exists(LPCSTR section, LPCSTR name,
                                     T (CInifile::*method)(LPCSTR, LPCSTR) const, T& value,
                                     bool test);

    template <typename T>
    IC static bool process_if_exists_set(LPCSTR section, LPCSTR name,
                                         T (CInifile::*method)(LPCSTR, LPCSTR) const, T& value,
                                         bool test);
