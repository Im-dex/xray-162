...
#define CGameVertexPathManager                                                                    \
    CPathManager<CGameGraph, _DataStorage, SGameVertex<_dist_type, _index_type, _iteration_type>, \
                 _dist_type, _index_type, _iteration_type\
>

TEMPLATE_SPECIALIZATION
IC void CGameVertexPathManager::setup(const _Graph* _graph, _DataStorage* _data_storage,
