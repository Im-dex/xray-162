...
IC bool CALifeSpawnRegistry::object_existance_limit(CSE_Abstract& abstract,
...
IC bool CALifeSpawnRegistry::can_spawn(CSE_Abstract& abstract, ALife::_TIME_ID game_time,
                                       SPAWN_IDS& objects) const {
...
void CALifeSpawnRegistry::fill_new_spawns(SPAWN_GRAPH::CVertex* vertex, SPAWN_IDS& spawns,
                                          ALife::_TIME_ID game_time, SPAWN_IDS& objects) {
    VERIFY(vertex);
