...
//	if ( !object ) {
//		Msg					( "there is now object[\"shkaf_work_01_door_0000\"]
//found" ); 		return;
//	}
//
...
//		Msg					( "object[\"shkaf_work_01_door_0000\"] has not been
//registered as a door yet" ); 		return;
//	}
//
//	door const* const found	= m_doors.find(
//game_object->lua_game_object()->m_door->position() ); 	if ( !found ) { 		Msg
//( "object[\"shkaf_work_01_door_0000\"] has been unregistered already[0x%08x]?",
//game_object->lua_game_object()->m_door ); 		return;
//	}
//
//	Msg						( "object[\"shkaf_work_01_door_0000\"] has been
//registered as a door" );
//}
//
door* manager::register_door(CPhysicObject& object) {
    ...
    //	Msg					( "registering door[\"shkaf_work_01_door_0000\"][%f][%f][%f]",
    //VPUSH(result->position()) );
    //}
    // check_bug_door			( );
...
void manager::unregister_door(door*& door) {
    ...
    //	Msg					( "UNregistering door[\"shkaf_work_01_door_0000\"][%f][%f][%f]",
    //VPUSH(door->position()) );
    //}
    // check_bug_door			( );
    m_doors.remove(door);
