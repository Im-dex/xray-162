...
void SndShockEffector::Update() {
    ...
    float y = 2.f * x - 1;
    if (y > 0.f) {
        psSoundVFactor = y * (m_stored_volume - m_stored_volume * SND_MIN_VOLUME_FACTOR) +
...
CControllerPsyHitCamEffector::CControllerPsyHitCamEffector(ECamEffectorType type,
...
void cam_effector_sub(const SCamEffectorInfo& c1, const SCamEffectorInfo& c2,
