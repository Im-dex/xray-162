...
void CObjectHandlerPlanner::add_evaluators(CWeapon* weapon) {
    ...
    //,new CObjectPropertyEvaluatorState(weapon,m_object,CWeapon::eHidden));
    add_evaluator(uid(id, eWorldPropertyHidden),
                  new CObjectPropertyEvaluatorWeaponHidden(weapon, m_object));

    // dynamic member properties
    add_evaluator(uid(id, eWorldPropertyAimed1),
                  new CObjectPropertyEvaluatorMember(&m_storage, eWorldPropertyAimed1, true));
    add_evaluator(uid(id, eWorldPropertyAimed2),
                  new CObjectPropertyEvaluatorMember(&m_storage, eWorldPropertyAimed2, true));
    add_evaluator(uid(id, eWorldPropertyStrapped),
                  new CObjectPropertyEvaluatorMember(&m_storage, eWorldPropertyStrapped, true));
    add_evaluator(
        uid(id, eWorldPropertyStrapped2Idle),
        new CObjectPropertyEvaluatorMember(&m_storage, eWorldPropertyStrapped2Idle, true));

    // dynamic properties
    add_evaluator(uid(id, eWorldPropertyAmmo1),
                  new CObjectPropertyEvaluatorAmmo(weapon, m_object, 0));
    add_evaluator(uid(id, eWorldPropertyAmmo2),
                  new CObjectPropertyEvaluatorAmmo(weapon, m_object, 1));
    add_evaluator(uid(id, eWorldPropertyEmpty1),
                  new CObjectPropertyEvaluatorEmpty(weapon, m_object, 0));
    add_evaluator(uid(id, eWorldPropertyEmpty2),
                  new CObjectPropertyEvaluatorEmpty(weapon, m_object, 1));
    add_evaluator(uid(id, eWorldPropertyFull1),
                  new CObjectPropertyEvaluatorFull(weapon, m_object, 0));
    add_evaluator(uid(id, eWorldPropertyFull2),
                  new CObjectPropertyEvaluatorFull(weapon, m_object, 1));
    add_evaluator(uid(id, eWorldPropertyReady1),
                  new CObjectPropertyEvaluatorReady(weapon, m_object, 0));
    add_evaluator(uid(id, eWorldPropertyReady2),
                  new CObjectPropertyEvaluatorReady(weapon, m_object, 1));
    add_evaluator(uid(id, eWorldPropertyQueueWait1),
                  new CObjectPropertyEvaluatorQueue(weapon, m_object, 0));
    add_evaluator(uid(id, eWorldPropertyQueueWait2),
                  new CObjectPropertyEvaluatorQueue(weapon, m_object, 1));
    ...
    add_evaluator(uid(id, eWorldPropertyFiringNoReload1),
                  new CObjectPropertyEvaluatorConst(false));
...
void CObjectHandlerPlanner::add_operators(CWeapon* weapon) {
    ...
    action =
        new CObjectActionStrappingToIdle(weapon, m_object, &m_storage, "strapping to idle");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    action =
        new CObjectActionUnstrappingToIdle(weapon, m_object, &m_storage, "unstrapping to idle");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertyStrapped, false);
    add_condition(action, id, eWorldPropertyStrapped2Idle, true);
    add_effect(action, id, eWorldPropertyStrapped2Idle, false);
    ...
    // aim1
    action =
        new CObjectActionAim(weapon, m_object, &m_storage, eWorldPropertyAimed1, true, "aim1");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    // aim2
    action =
        new CObjectActionAim(weapon, m_object, &m_storage, eWorldPropertyAimed2, true, "aim2");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    // aim_queue1
    action = new CObjectActionQueueWait(weapon, m_object, &m_storage,
                                            uid(id, eWorldPropertyQueueWait1), "aim_queue1");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertySwitch1, true);
    ...
    // aim_queue2
    action = new CObjectActionQueueWait(weapon, m_object, &m_storage,
                                            uid(id, eWorldPropertyQueueWait2), "aim_queue2");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertySwitch1, true);
    ...
    // fire1
    action = new CObjectActionFire(weapon, m_object, &m_storage,
                                       uid(id, eWorldPropertyQueueWait1), "fire1");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    // fire no reload
    action = new CObjectActionFireNoReload(weapon, m_object, &m_storage,
                                               uid(id, eWorldPropertyQueueWait1), "fire_no_reload");
    add_condition(action, id, eWorldPropertyHidden, false);
    //	add_condition		(action,id,eWorldPropertyEmpty1,	false);
    //	add_condition		(action,id,eWorldPropertyAimed1,	true);
    add_condition(action, id, eWorldPropertySwitch1, true);
    ...
    // fire2
    action = new CObjectActionFire(weapon, m_object, &m_storage,
                                       uid(id, eWorldPropertyQueueWait2), "fire2");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    // aiming ready1
    action = new CObjectActionAim(weapon, m_object, &m_storage, eWorldPropertyAimed1, true,
                                      "aim_ready1");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertySwitch1, true);
    add_condition(action, id, eWorldPropertyReady1, true);
    ...
    // aiming ready2
    action = new CObjectActionAim(weapon, m_object, &m_storage, eWorldPropertyAimed2, true,
                                      "aim_ready2");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertySwitch2, true);
    add_condition(action, id, eWorldPropertyStrapped, false);
