...
void CObjectHandlerPlanner::add_operators(CWeapon* weapon) {
    ...
    action =
        xr_new<CObjectActionStrappingToIdle>(weapon, m_object, &m_storage, "strapping to idle");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    action =
        xr_new<CObjectActionUnstrappingToIdle>(weapon, m_object, &m_storage, "unstrapping to idle");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertyStrapped, false);
    add_condition(action, id, eWorldPropertyStrapped2Idle, true);
    add_effect(action, id, eWorldPropertyStrapped2Idle, false);
    ...
    // aim1
    action =
        xr_new<CObjectActionAim>(weapon, m_object, &m_storage, eWorldPropertyAimed1, true, "aim1");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    // aim2
    action =
        xr_new<CObjectActionAim>(weapon, m_object, &m_storage, eWorldPropertyAimed2, true, "aim2");
    add_condition(action, id, eWorldPropertyHidden, false);
    ...
    // aim_queue1
    action = xr_new<CObjectActionQueueWait>(weapon, m_object, &m_storage,
    ...
    // fire no reload
    action = xr_new<CObjectActionFireNoReload>(weapon, m_object, &m_storage,
    ...
    // aiming ready1
    action = xr_new<CObjectActionAim>(weapon, m_object, &m_storage, eWorldPropertyAimed1, true,
                                      "aim_ready1");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertySwitch1, true);
    add_condition(action, id, eWorldPropertyReady1, true);
    ...
    // aiming ready2
    action = xr_new<CObjectActionAim>(weapon, m_object, &m_storage, eWorldPropertyAimed2, true,
                                      "aim_ready2");
    add_condition(action, id, eWorldPropertyHidden, false);
    add_condition(action, id, eWorldPropertySwitch2, true);
    add_condition(action, id, eWorldPropertyStrapped, false);
