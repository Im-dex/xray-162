...
GameEvent* GameEventQueue::Retreive() {
    ...
    //---------------------------------------------
        ...
        if ((LastTimeCreate < tmp_time) && (size > 32)) {
            ...
            unused.pop_back();
#ifdef _DEBUG
//			Msg ("GameEventQueue::Retreive - ready %d, unused %d", ready.size(),
//unused.size());
#endif
        }
    }
...
#ifdef _DEBUG
//			Msg ("GameEventQueue::EraseEvents - ready %d, unused %d", ready.size(),
//unused.size());
#endif
        } else {
...
//-----
#ifdef DEBUG
        Msg("! GameEventQueue::EraseEvents - destroying event type[%d], sender[0x%08x]",
