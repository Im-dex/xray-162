...
ALife::EMeetActionType CSE_ALifeHumanAbstract::tfGetActionType(CSE_ALifeSchedulable* schedulable,
                                                               int iGroupIndex,
...
CSE_ALifeItemWeapon* CSE_ALifeHumanAbstract::tpfGetBestWeapon(ALife::EHitType& tHitType,
                                                              float& fHitPower) {
