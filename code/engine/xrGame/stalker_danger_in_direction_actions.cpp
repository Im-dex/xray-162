...
void CStalkerActionDangerInDirectionTakeCover::initialize() {
    ...
    float distance =
        object().memory().danger().selected()->position().distance_to(object().Position());
...
CStalkerActionDangerInDirectionLookOut::CStalkerActionDangerInDirectionLookOut(CAI_Stalker* object,
                                                                               LPCSTR action_name)
    : inherited(object, action_name) {
...
void CStalkerActionDangerInDirectionLookOut::execute() {
    ...
    const CCoverPoint* point =
        ai().cover_manager().best_cover(object().Position(), 10.f, *object().m_ce_close,
...
CStalkerActionDangerInDirectionDetour::CStalkerActionDangerInDirectionDetour(CAI_Stalker* object,
                                                                             LPCSTR action_name)
    : inherited(object, action_name) {}
...
CStalkerActionDangerInDirectionSearch::CStalkerActionDangerInDirectionSearch(CAI_Stalker* object,
                                                                             LPCSTR action_name)
    : inherited(object, action_name) {}
