...
void CStalkerALifePlanner::add_evaluators() {
    add_evaluator(eWorldPropertyPuzzleSolved,
                  new CStalkerPropertyEvaluatorConst(false, "zone puzzle solved"));
    add_evaluator(eWorldPropertySmartTerrainTask, new CStalkerPropertyEvaluatorSmartTerrainTask(
                                                      m_object, "under smart terrain"));
    add_evaluator(eWorldPropertyALife,
                  new CStalkerPropertyEvaluatorALife(m_object, "ALife Simulator"));
}
