...
IC CScriptSoundAction::CScriptSoundAction(LPCSTR caSoundToPlay, LPCSTR caBoneName,
                                          ...
                                          const Fvector& tAngleOffset, bool bLooped,
...
IC CScriptSoundAction::CScriptSoundAction(LPCSTR caSoundToPlay, Fvector* tPosition,
                                          const Fvector& tAngleOffset, bool bLooped,
                                          ESoundTypes sound_type) {
    m_bLooped = bLooped;
    SetSound(caSoundToPlay);
...
IC CScriptSoundAction::CScriptSoundAction(CScriptSound* sound, LPCSTR caBoneName,
...
IC CScriptSoundAction::CScriptSoundAction(CScriptSound* sound, Fvector* tPosition,
                                          const Fvector& tAngleOffset, bool bLooped,
                                          ESoundTypes sound_type) {
    m_bLooped = bLooped;
    SetSound(*sound);
