...
IC void CDetailPathManager::assign_angle(float& angle, const float start_yaw, const float dest_yaw,
...
IC const CDetailPathManager::STravelParams&
CDetailPathManager::velocity(const u32& velocity_id) const {
