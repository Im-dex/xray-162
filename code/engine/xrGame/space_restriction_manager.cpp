...
CSpaceRestrictionManager::restriction(ALife::_OBJECT_ID id) {
    CLIENT_RESTRICTIONS::iterator I = m_clients->find(id);
    VERIFY(m_clients->end() != I);
...
void CSpaceRestrictionManager::restrict(ALife::_OBJECT_ID id, shared_str out_restrictors,
    ...
    CLIENT_RESTRICTIONS::iterator I = m_clients->find(id);
    VERIFY2((m_clients->end() == I) || !(*I).second.m_restriction ||
...
u32 CSpaceRestrictionManager::accessible_nearest(ALife::_OBJECT_ID id, const Fvector& position,
                                                 Fvector& result) {
    CRestrictionPtr client_restriction = restriction(id);
...
IC bool CSpaceRestrictionManager::restriction_presented(shared_str restrictions,
...
IC void CSpaceRestrictionManager::difference_restrictions(shared_str& restrictions,
                                                          shared_str update) {
    string4096 m_temp1;
    string4096 m_temp2;
    xr_strcpy(m_temp2, "");
...
void CSpaceRestrictionManager::add_restrictions(ALife::_OBJECT_ID id,
...
void CSpaceRestrictionManager::remove_restrictions(ALife::_OBJECT_ID id,
...
void CSpaceRestrictionManager::change_restrictions(ALife::_OBJECT_ID id,
                                                   shared_str add_out_restrictions,
                                                   shared_str add_in_restrictions,
                                                   shared_str remove_out_restrictions,
                                                   shared_str remove_in_restrictions) {
