...
void CMovementManager::Load(LPCSTR section) {
    ...
    m_game_location_selector =
        xr_new<CGameLocationSelector>(m_restricted_object, m_location_manager);
...
void CMovementManager::enable_movement(bool enabled) {
    //	m_path_actuality					= m_path_actuality && (m_enabled ==
    //enabled);
