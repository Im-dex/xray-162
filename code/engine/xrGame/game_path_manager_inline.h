...
#define CGameManagerTemplate \
    CBasePathManager<CGameGraph, _VertexEvaluator, _vertex_id_type, _index_type>
...
TEMPLATE_SPECIALIZATION
IC void CGameManagerTemplate::before_search(const _vertex_id_type start_vertex_id,
