...
CProfiler::CProfiler() { m_actual = true; }
...
void CProfiler::show_stats(CGameFont* game_font, bool show) {
    ...
    for (; I != E; ++I) {
        ...
        float average =
            (*I).second.m_count ? (*I).second.m_total_time / float((*I).second.m_count) : 0.f;
        ...
        game_font->OutNext(
            ...
            "%s%c%c %8.3f %8.3f %8.3f %6.1f %8d %12.3f", *(*I).second.m_name, white_character,
            white_character, (*I).second.m_time, average, (*I).second.m_max_time,
