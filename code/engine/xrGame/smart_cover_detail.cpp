...
float smart_cover::detail::parse_float(luabind::object const& table, LPCSTR identifier,
                                       float const& min_threshold, float const& max_threshold) {
...
void smart_cover::detail::parse_table(luabind::object const& table, LPCSTR identifier,
