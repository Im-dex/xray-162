...
protected:
    ...
    virtual void BloodyWallmarks(float P, const Fvector& dir, s16 element,
...
protected:
    virtual void PlaceBloodWallmark(const Fvector& dir, const Fvector& start_pos, float trace_dist,
