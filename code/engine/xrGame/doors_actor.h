...
private:
    bool add_new_door(float average_speed, door* door, doors_type const& processed_doors,
                      doors_type& locked_doors, temp_doors_type& new_doors, door_state state);
    void process_doors(float average_speed, doors_type& processed_doors,
                       temp_doors_type const& new_doors, door_state start_state,
