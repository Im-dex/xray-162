 ...
 *	\warning	THIS IS A CONSERVATIVE TEST !! Some triangles will be returned as
 *intersecting, while they're not!
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    while (Mask <= in_clip_mask) {
        if (in_clip_mask & Mask) {
            ...
            if (d0 > 0.0f && d1 > 0.0f && d2 > 0.0f)
                return FALSE;
            //			if(!(IR(d0)&SIGN_BITMASK) && !(IR(d1)&SIGN_BITMASK) && !(IR(d2)&SIGN_BITMASK))
            //return FALSE;
        }
        Mask += Mask;
        p++;
