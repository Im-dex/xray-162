 ...
 *	- original code by Ville Miettinen, from Umbra/dPVS (released on the GD-Algorithms mailing
 *list) - almost used "as-is", I even left the comments (hence the frustum-related notes)
 *
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL PlanesCollider::PlanesAABBOverlap(const Point& center, const Point& extents,
    ...
    // clip mask. Most FPUs have a native single-cycle xr::abs() operation.
    ...
    while (Mask <= in_clip_mask) // keep looping while we have active planes left...
    {
        ...
        {
            float NP = extents.x * xr::abs(p->n.x) + extents.y * xr::abs(p->n.y) +
                       extents.z * xr::abs(p->n.z); // ### xr::abs could be precomputed
