...
public:
     ...
     *	- GetPairs()
     *
     *	\param		cache			[in] collision cache for model pointers and a colliding pair of
     *primitives \param		world0			[in] world matrix for first object, or null
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Settings: selects between full box-box tests or "SAT-lite" tests (where Class III axes are
     *discarded) \param		flag		[in] true for full tests, false for coarse tests
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Settings: selects between full triangle-box tests or "SAT-lite" tests (where Class III axes
     *are discarded) \param		flag		[in] true for full tests, false for coarse
     *tests \see		SetFullBoxBoxTest(bool flag)
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Callback control: a method to setup callback 0. Must provide triangle-vertices for a given
     *triangle index. \param		callback	[in] user-defined callback \param
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Callback control: a method to setup callback 1. Must provide triangle-vertices for a given
     *triangle index. \param		callback	[in] user-defined callback \param
     *data		[in] user-defined data
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Pointers control: a method to setup object0 pointers. Must provide access to faces and
     *vertices for a given object. \param		faces	[in] pointer to faces \param
     *verts	[in] pointer to vertices \see		SetPointers1(const Triangle* faces, const
     *Point* verts)
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Pointers control: a method to setup object1 pointers. Must provide access to faces and
     *vertices for a given object. \param		faces	[in] pointer to faces \param
     *verts	[in] pointer to vertices \see		SetPointers0(const Triangle* faces, const
     *Point* verts)
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
protected:
    ...
    void _Collide(const AABBQuantizedNode* b0, const AABBQuantizedNode* b1, const Point& a,
    ...
    inline_ BOOL TriTriOverlap(const Point& V0, const Point& V1, const Point& V2, const Point& U0,
