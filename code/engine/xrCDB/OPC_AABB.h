...
#define AABB_COMMON_METHODS                                                                      \
    ...
    float CalculateBoxArea(const icePoint& eye, const Matrix4x4& mat, float width, float height, \
                           int& num) const;                                                      \
...
public:
    ...
    inline_ bool Intersect(const AABB& a) const {
        if (mMax.x < a.mMin.x || a.mMax.x < mMin.x || mMax.y < a.mMin.y || a.mMax.y < mMin.y ||
...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	The standard intersection method from Gamasutra. Just here to check its speed against the
     *one above. \param		a		[in] the other AABB \return		true on
     *intersection
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    inline_ void Rotate(const Matrix4x4& mtx, AABB& aabb) const {
        ...
        // Compute _new_ extents. FPU code & CPU code have been interleaved for improved
        // performance.
