 ...
 *	\param		triangle_index	[in] face index for which the system is requesting the
 *vertices
 *	\param		triangle		[out] triangle's vertices (must be provided by the
 *user) \param		user_data		[in] user-defined data from SetCallback()
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
inline_ void TransformPoint(Point& dest, const Point& source, const Matrix3x3& rot,
                            const Point& trans) {
