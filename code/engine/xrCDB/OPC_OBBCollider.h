...
public:
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool Collide(OBBCache& cache, const OBB& box, OPCODE_Model* model,
                 const Matrix4x4* worldb = null, const Matrix4x4* worldm = null);

    // Collision queries
    bool Collide(OBBCache& cache, const OBB& box, const AABBCollisionTree* tree,
                 const Matrix4x4* worldb = null, const Matrix4x4* worldm = null);
    bool Collide(OBBCache& cache, const OBB& box, const AABBNoLeafTree* tree,
                 const Matrix4x4* worldb = null, const Matrix4x4* worldm = null);
    bool Collide(OBBCache& cache, const OBB& box, const AABBQuantizedTree* tree,
                 const Matrix4x4* worldb = null, const Matrix4x4* worldm = null);
    bool Collide(OBBCache& cache, const OBB& box, const AABBQuantizedNoLeafTree* tree,
                 const Matrix4x4* worldb = null, const Matrix4x4* worldm = null);
    // Settings

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Settings: select between full box-box tests or "SAT-lite" tests (where Class III axes are
...
protected:
    ...
    // Init methods
    BOOL InitQuery(OBBCache& cache, const OBB& box, const Matrix4x4* worldb = null,
