 ...
 *
 *		In Opcode, we support segment queries, which yield half-line queries by setting d =
 *+infinity. We don't support line-queries. If you need them, shift the origin along the ray by an
 *appropriate margin.
 *
 *		In short, the lower bound is always 0, and you can setup the higher bound "d" with
 ...
 *RayCollider::SetFirstContact(). - In "first contact" mode we return as soon as the ray hits one
 *face. If can be useful e.g. for shadow feelers, where you want to know whether the path to the
 *light is _free or not (a boolean answer is enough). - In "all contacts" mode we return all faces
 *hit by the ray.
 *
 *	TEMPORAL COHERENCE:
 *
 *		- You can enable or disable temporal coherence with
 *RayCollider::SetTemporalCoherence(). - It currently only works in "first contact" mode. - If
 *temporal coherence is enabled, the previously hit triangle is cached during the first query.
 *Then, next queries start by colliding the ray against the cached triangle. If they still collide,
 ...
 *		- If closest hit is enabled, faces are sorted by distance on-the-fly and the closest
 *one only is reported.
 *
 *	BACKFACE CULLING:
 *
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Validates current settings. You should call this method after all the settings and callbacks
 *have been defined. \return		null if everything is ok, else a string describing the
 *problem
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 *	\warning	SCALE NOT SUPPORTED. The matrices must contain rotation & translation parts
 *only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray& world_ray, OPCODE_Model* model, const Matrix4x4* world,
                          udword* cache) {
    // Checkings
    if (!model)
        return false;
    ...
    if (!model->HasLeafNodes()) {
        if (model->IsQuantized())
            return Collide(world_ray, (const AABBQuantizedNoLeafTree*)model->GetTree(), world,
                           cache);
        else
 ...
 *	\warning	SCALE NOT SUPPORTED. The matrix must contain rotation & translation parts
 *only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray& world_ray, const AABBCollisionTree* tree,
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray& world_ray, const AABBNoLeafTree* tree, const Matrix4x4* world,
                          udword* cache) {
    // Checkings
    if (!tree)
        return false;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray& world_ray, const AABBQuantizedTree* tree,
                          const Matrix4x4* world, udword* cache) {
    // Checkings
    if (!tree)
        return false;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray& world_ray, const AABBQuantizedNoLeafTree* tree,
                          const Matrix4x4* world, udword* cache) {
    // Checkings
    if (!tree)
        return false;
