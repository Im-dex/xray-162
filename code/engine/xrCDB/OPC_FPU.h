...
//! Don't use it blindly, it can be faster or slower than the FPU comparison, depends on the
//! context.
...
*/
//! This function computes the slowest possible floating-point value (you can also directly use
//! FLT_EPSILON)
