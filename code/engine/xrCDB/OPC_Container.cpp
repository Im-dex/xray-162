...
bool Container::Resize(udword needed) {
    ...
    // Get more entries
    mMaxNbEntries =
        mMaxNbEntries ? udword(float(mMaxNbEntries) * mGrowthFactor) : 2; // Default nb Entries = 2
 ...
 *	\return		true if the value has been found in the container, else false.
 *	\warning	This method is arbitrary slow (O(n)) and should be used carefully. Insertion
...
bool Container::Delete(udword entry) {
    ...
    for (udword i = 0; i < mCurNbEntries; i++) {
        if (mEntries[i] == entry) {
            // Entry has been found at index i. The strategy is to copy the last current entry at
            // index i, and decrement the current number of entries.
            DeleteIndex(i);
            return true;
        }
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Deletes an entry, preserving the insertion order. If the container contains such an entry,
 *it's removed. \param		entry		[in] the value to _delete_.
 *	\return		true if the value has been found in the container, else false.
 ...
 *	\param		entry		[in/out] On input, the entry to look for. On output, the
 *next entry \param		wrap		[in] true to wrap at the end of the array \return
 *Self-Reference
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 *	\param		entry		[in/out] On input, the entry to look for. On output, the
 *previous entry \param		wrap		[in] true to wrap at the end of the array \return
 *Self-Reference
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
