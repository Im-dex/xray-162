...
void CSE_ALifeObjectHangingLamp::script_register(lua_State* L) {
    module(
        L)[luabind_class_dynamic_alife2(CSE_ALifeObjectHangingLamp, "cse_alife_object_hanging_lamp",
...
void CSE_ALifeSmartZone::script_register(lua_State* L) {
    module(L)[luabind_class_zone2(CSE_ALifeSmartZone, "cse_alife_smart_zone",
