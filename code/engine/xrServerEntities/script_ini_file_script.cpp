...
bool r_line(CScriptIniFile* self, LPCSTR S, int L, luabind::internal_string& N,
...
CScriptIniFile* create_ini_file(LPCSTR ini_string) {
    return ((CScriptIniFile*)new CInifile(&IReader((void*)ini_string, xr_strlen(ini_string)),
