...
public:
    ...
    virtual int CS_LUA_STUDIO_BACKEND_CALL lua_sethook(lua_State* L, lua_Hook func,
                                                       lua_mask_type mask, int count);
    virtual lua_Hook CS_LUA_STUDIO_BACKEND_CALL lua_gethook(lua_State* L);

    virtual int CS_LUA_STUDIO_BACKEND_CALL lua_getinfo(lua_State* L, const char* what,
                                                       lua_Debug* ar);
    ...
    virtual char const* CS_LUA_STUDIO_BACKEND_CALL lua_getlocal(lua_State* L, const lua_Debug* ar,
                                                                int n);
    ...
    virtual char const* CS_LUA_STUDIO_BACKEND_CALL lua_getupvalue(lua_State* L, int funcindex,
                                                                  int n);
    ...
    virtual int CS_LUA_STUDIO_BACKEND_CALL lua_pcall(lua_State* L, int nargs, int nresults,
                                                     int errfunc);
    ...
    virtual char const* CS_LUA_STUDIO_BACKEND_CALL lua_tolstring(lua_State* L, int idx,
                                                                 size_t* len);
...
public:
    virtual void CS_LUA_STUDIO_BACKEND_CALL log(log_message_types message_type,
                                                char const* message);
    virtual bool CS_LUA_STUDIO_BACKEND_CALL type_to_string(char* buffer, unsigned int size,
                                                           lua_State* state, int index,
                                                           bool& use_in_description);
    virtual bool CS_LUA_STUDIO_BACKEND_CALL value_to_string(cs::lua_studio::backend& backend,
...
private:
    ...
    bool value_convert_instance(cs::lua_studio::backend& backend, char* buffer, unsigned int size,
                                lua_State* state, int index, cs::lua_studio::icon_type& icon_type,
                                bool full_description);
...
private:
    void fill_class_data(cs::lua_studio::backend& backend,
                         cs::lua_studio::value_to_expand& value_to_expand, lua_State* const state);
    void expand_class(cs::lua_studio::backend& backend, cs::lua_studio::value_to_expand& value,
                      lua_State* const state);
    void expand_class_instance(cs::lua_studio::backend& backend,
                               cs::lua_studio::value_to_expand& value_to_expand,
                               lua_State* const state);
    void expand_user_data(cs::lua_studio::backend& backend, cs::lua_studio::value_to_expand& value,
                          lua_State* const state);
