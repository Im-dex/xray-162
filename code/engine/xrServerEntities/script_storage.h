...
protected:
    static int vscript_log(ScriptStorage::ELuaMessageType tLuaMessageType, LPCSTR caFormat,
                           va_list marker);
    bool parse_namespace(LPCSTR caNamespaceName, LPSTR b, u32 const b_size, LPSTR c,
                         u32 const c_size);
...
public:
    ...
    bool load_buffer(lua_State* L, LPCSTR caBuffer, size_t tSize, LPCSTR caScriptName,
