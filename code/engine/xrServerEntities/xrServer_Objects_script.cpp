...
inline LPCSTR get_name(const CSE_Abstract* abstract) { return abstract->name_replace(); }
...
struct CWrapperBase : public T, public luabind::wrap_base {
    ...
    CWrapperBase(LPCSTR section) : T(section) {}
...
void CPureServerObject::script_register(lua_State* L) {
    module(
        L)[class_<IPureLoadableObject<IReader>>("ipure_alife_load_object"),
           class_<IPureSavableObject<IWriter>>("ipure_alife_save_object"),
           class_<IPureSerializeObject<IReader, IWriter>,
                  bases<IPureLoadableObject<IReader>, IPureSavableObject<IWriter>>>(
