...
#define script_type_list save_type_list(CSE_ALifeTraderAbstract)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeTrader, CSE_ALifeDynamicObjectVisual,
                                 CSE_ALifeTraderAbstract) CSE_ALifeTrader(LPCSTR caSection);
...
#define script_type_list save_type_list(CSE_ALifeCustomZone)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeAnomalousZone,
                                CSE_ALifeCustomZone) CSE_ALifeItemWeapon* m_tpCurrentBestWeapon;
...
#define script_type_list save_type_list(CSE_ALifeTorridZone)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeZoneVisual, CSE_ALifeAnomalousZone,
                                 CSE_Visual) shared_str attack_animation;
...
#define script_type_list save_type_list(CSE_ALifeZoneVisual)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeCreatureAbstract, CSE_ALifeDynamicObjectVisual) private
    : float fHealth;
...
#define script_type_list save_type_list(CSE_ALifeCreatureAbstract)
    ...
    SERVER_ENTITY_DECLARE_BEGIN3(CSE_ALifeMonsterAbstract, CSE_ALifeCreatureAbstract,
                                 CSE_ALifeSchedulable, CMovementManagerHolder)
...
#define script_type_list save_type_list(CSE_ALifeMonsterAbstract)
    ...
    SERVER_ENTITY_DECLARE_BEGIN3(CSE_ALifeCreatureActor, CSE_ALifeCreatureAbstract,
...
// статический массив - 6 float(вектора пределов квантизации) + m_u16NumItems*(7 u8) (позиция и
// поворот кости)
u8 m_BoneDataSize;
...
#define script_type_list save_type_list(CSE_ALifeCreaturePhantom)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeMonsterRat, CSE_ALifeMonsterAbstract,
...
#define script_type_list save_type_list(CSE_ALifeMonsterZombie)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeMonsterBase, CSE_ALifeMonsterAbstract,
                                 CSE_PHSkeleton) u16 m_spec_object_id;
...
#define script_type_list save_type_list(CSE_ALifePsyDogPhantom)
    ...
    //-------------------------------
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeHumanAbstract, CSE_ALifeTraderAbstract,
...
#define script_type_list save_type_list(CSE_ALifeHumanStalker)
    ...
    SERVER_ENTITY_DECLARE_BEGIN3(CSE_ALifeOnlineOfflineGroup, CSE_ALifeDynamicObject,
                                 CSE_ALifeSchedulable, CMovementManagerHolder) public
