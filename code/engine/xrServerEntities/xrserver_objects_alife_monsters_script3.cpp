...
void CSE_ALifeCreatureActor::script_register(lua_State* L) {
    module(L)[luabind_class_creature3(CSE_ALifeCreatureActor, "cse_alife_creature_actor",
                                      CSE_ALifeCreatureAbstract, CSE_ALifeTraderAbstract,
                                      CSE_PHSkeleton)];
}

void CSE_ALifeTorridZone::script_register(lua_State* L) {
    module(L)[luabind_class_dynamic_alife2(CSE_ALifeTorridZone, "cse_torrid_zone",
                                           CSE_ALifeCustomZone, CSE_Motion)];
}

void CSE_ALifeZoneVisual::script_register(lua_State* L) {
    module(L)[luabind_class_dynamic_alife2(CSE_ALifeZoneVisual, "cse_zone_visual",
                                           CSE_ALifeAnomalousZone, CSE_Visual)];
}

void CSE_ALifeCreaturePhantom::script_register(lua_State* L) {
    module(L)[luabind_class_creature1(CSE_ALifeCreaturePhantom, "cse_alife_creature_phantom",
...
void CSE_ALifeOnlineOfflineGroup::script_register(lua_State* L) {
    module(L)[class_<MEMBERS::value_type>("MEMBERS__value_type")
              ...
              luabind_class_online_offline_group2(CSE_ALifeOnlineOfflineGroup,
                  ...
                  .def("squad_members", &CSE_ALifeOnlineOfflineGroup::squad_members,
                       return_stl_iterator)
