...
virtual ALife::EMeetActionType tfGetActionType(CSE_ALifeSchedulable* tpALifeSchedulable,
                                               int iGroupIndex, bool bMutualDetection) = 0;
...
#define script_type_list save_type_list(CSE_ALifeSchedulable)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeGraphPoint, CSE_Abstract) public
...
void detach(CSE_ALifeInventoryItem* tpALifeInventoryItem, ALife::OBJECT_IT* I = nullptr,
            bool bALifeRequest = true, bool bRemoveChildren = true);
...
#define script_type_list save_type_list(CSE_ALifeDynamicObjectVisual)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifePHSkeletonObject, CSE_ALifeDynamicObjectVisual,
                                 CSE_PHSkeleton) CSE_ALifePHSkeletonObject(LPCSTR caSection);
...
#define script_type_list save_type_list(CSE_ALifeSpaceRestrictor)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeLevelChanger,
                                CSE_ALifeSpaceRestrictor) GameGraph::_GRAPH_ID m_tNextGraphID;
u32 m_dwNextNodeID;
...
#define script_type_list save_type_list(CSE_ALifeSmartZone)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeObjectPhysic, CSE_ALifeDynamicObjectVisual,
                                 CSE_PHSkeleton) u32 type;
f32 mass;
...
//r){inherited::load(r);} 	using inherited::load(IReader&);
private:
u32 m_freeze_time;
...
#define script_type_list save_type_list(CSE_ALifeObjectPhysic)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeObjectHangingLamp, CSE_ALifeDynamicObjectVisual,
                                 CSE_PHSkeleton)
...
#define script_type_list save_type_list(CSE_ALifeHelicopter)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeCar, CSE_ALifeDynamicObjectVisual,
                                 CSE_PHSkeleton) struct SDoorState {
...
#define script_type_list save_type_list(CSE_ALifeCar)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeObjectBreakable,
                                CSE_ALifeDynamicObjectVisual) float m_health;
...
#define script_type_list save_type_list(CSE_ALifeMountedWeapon)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeStationaryMgun,
                                CSE_ALifeDynamicObjectVisual) bool m_bWorking;
...
#define script_type_list save_type_list(CSE_ALifeTeamBaseZone)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeInventoryBox,
                                CSE_ALifeDynamicObjectVisual) bool m_can_take;
bool m_closed;
