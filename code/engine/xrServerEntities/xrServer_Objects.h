...
// 17 - xrSE_...						inherited from CSE_Visual for smart Level
// Editor 18 - xrSE_ALifeObjectHangingLamp		appended with 'startup_animation' 19 -
// xrSE_Teamed						didn't save health parameter 20 -
// xrSE_ALife...					saving vectors in UPDATE_Read/UPDATE_Write changed to
// STATE_Read/STATE_Write 21 -	GLOBAL CLASS HIERARCHY UPDATE
...
// 25 - CSE_ALifeObject					changed type of the property probability from u8 to
// float 26 - CSE_AnomalousZone				appended with artefact spawn information 27
// - CSE_AnomalousZone				weights changed type from u32 to float 28 -
// CSE_AnomalousZone				appended with an anomalous zone type 29 -
// CSE_ALifeObjectPhysic			appended with an animation property 30 -
// CSE_ALifeTrader					appended with an ordered artefacts property
...
// 36 - CSE_ALifeTrader					appended with the organization identifier
// property
...
// 51 - CSE_ALifeItemBolt				new class based on CSE_ALifeDynamicObject and
// CSE_AlifeInventoryItem 52 - CSE_ALifeItemExplosive			new class based on
// CSE_ALifeItem 53 - CSE_AlifeInventoryItem			appended with property 'condition'
...
// 64 - CSE_ALifeObjectPhysic			flags, source_id, saved_bones moved to
// CSE_AlifePHSkeletonObject 65 - CSE_ALifeObjectPhysic			startup_anim moved to
// CSE_AlifePHSkeletonObject 66 - CSE_ALifeObjectPhysic			CSE_ALifeCar - heritage
// changed 67 - CSE_ALifeCustomZone				new class appended, heritage changed
...
// 70 -	CSE_Abstract					appended with m_script_version, script version
// support
// 71 -	CSE_Abstract					appended with m_client_data, ability to save/load
// client data 72 -	CSE_AlifeInventoryItem			removed property m_eItemPlace, added
// flag 73 -	CSE_AlifeMonsterAbstract		appended with property m_space_restrictors
...
// 80 - CSE_Abstract					m_tSpawnID property moved from CSE_ALifeObject to
// CSE_Abstract 81 - CSE_SpawnGroup					appended with 4 properties
// 82 - CSE_AlifeTraderAbstract			load/save m_iCharacterProfile on state read/write
// 83 - CSE_AlifeObject					m_fProbability moved to CSE_Abstract, m_dwSpawnGroup
// is removed completely 84 - CSE_SpawnGroup					appended with a
// property 85 - CSE_SpawnGroup					all the properties moved to
// CSE_Abstract 86 - CSE_AlifeTraderAbstract			appended with m_community_index 87 -
// CSE_AlifeTraderAbstract			appended with m_rank, m_reputation 88 -
// CSE_ALifeCreatureAbstract		appended with m_dynamic_restrictions property 89 -
// CSE_AlifeCreatureActor			appended with m_holderID 90 - CSE_ALifeItemPDA
// appended with m_specific_character, m_info_portion
...
// 96 - CSE_ALifeTraderAbstract			changed m_iCharacterProfile(int) to
// m_sCharacterProfile(shared_str) 97 - CSE_ALifeItemPDA				changed
// m_info_portion(int) to m_info_portion(shared_str) +m_specific_character +CSE_ALifeItemDocument
// m_wDoc (int-> shared_str)
// 98 - CSE_ALifeItemPDA				changed m_info_portion(int) to
// m_info_portion(shared_str) +m_specific_character +CSE_ALifeItemDocument m_wDoc (int-> shared_str)
// 99 - CSE_ALifeObjectClimable			inheritance changed CSE_Abstruct -> CSE_AlifeObject
// 100 - CSE_ALifeObjectClimable		inheritance changed CSE_AlifeObject ->
// CSE_AlifeDynamicObject 101 - CSE_ALifeCreaturePhantom		new class based on
// CSE_ALifeCreatureAbstract 102 - CSE_ALifeAnomalousZone			appended m_owner_id
// 103 - CSE_ALifeCustomZone			appended m_owner_id,removed from
// CSE_ALifeAnomalousZone 104 - CSE_Visual						appended
// flags 105 - CSE_ALifeTraderAbstract		added full name 106 - CSE_ALifeCustomZone
// enabled\disabled time 107 - CSE_ALifeCustomZone			enabled\disabled time
// extended 108 - CSE_ALifeTraderAbstract		removed property m_tpEvents 109 -
// CSE_ALifeBaseMonster			added property m_spec_object 110 - CSE_ALifeHumanAbstract
// removed a lot 111 - CSE_ALifeHumanStalker			removed demo mode 112 - CSE_Abstract
// removed all the spawn properties, sad but true
...
// 118 - CALifeHumanBrain				removed property m_tpKnownCustomers, sad but
// true 119 - CSE_ALifeObjectHangingLamp		added property	m_volumetric_quality
//										added property
//m_volumetric_intensity
//										added property
//m_volumetric_distance
...
#define script_type_list save_type_list(CSE_PHSkeleton)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_AbstractVisual, CSE_Abstract,
                                 CSE_Visual) typedef CSE_Abstract inherited1;
...
public:
                                                                        CSE_SpawnGroup
(LPCSTR caSection); virtual							~CSE_SpawnGroup	();
SERVER_ENTITY_DECLARE_END
