...
#define TEMPLATE_SPECIALIZATION \
    template <typename _key_type, typename _value_type, typename _compare_predicate_type>
...
TEMPLATE_SPECIALIZATION
IC bool _associative_vector_compare_predicate::operator()(const _key_type& lhs,
                                                          const _key_type& rhs) const {
    return (inherited::operator()(lhs, rhs));
}

TEMPLATE_SPECIALIZATION
IC bool _associative_vector_compare_predicate::operator()(const value_type& lhs,
