...
void CScriptFlags::script_register(lua_State* L) {
    module(L)[
        ...
        //Flags8&))(&Flags8::invert)) 			.def("invert",	(Flags8& (Flags8::*)(const
        //Flags8::TYPE))(&Flags8::invert)) 			.def("assign",	(Flags8&
        //(Flags8::*)(const Flags8&))(&Flags8::assign)) 			.def("assign",
        //(Flags8& (Flags8::*)(const Flags8::TYPE))(&Flags8::assign))
        //			.def("or",		(Flags8& (Flags8::*)(const
        //Flags8::TYPE))(&Flags8::or))
        //			.def("or",		(Flags8& (Flags8::*)(const Flags8&,const
        //Flags8::TYPE))(&Flags8::or))
        //			.def("and",		(Flags8& (Flags8::*)(const
        //Flags8::TYPE))(&Flags8::and)) 			.def("and",		(Flags8&
        //(Flags8::*)(const Flags8&,const Flags8::TYPE))(&Flags8::and))
        //			.def("set",		&set<Flags8>)
        //			.def("is",		&is<Flags8>)
        //			.def("is_any",	&is_any<Flags8>)
        //			.def("test",	&test<Flags8>)
        //			.def("equal",	(bool (*)(Flags8*,const Flags8&))(&equal<Flags8>))
        //			.def("equal",	(bool (*)(Flags8*,const Flags8&,const
        //Flags8::TYPE))(&equal<Flags8>)),
        //
        class_<Flags16>("flags16")
            ...
            .def("and",
                 (Flags16 & (Flags16::*)(const Flags16&, const Flags16::TYPE))(&Flags16::and))
            .def("set", &set<Flags16>)
            .def("is", &is<Flags16>)
            ...
            .def("equal",
                 (bool (*)(Flags16*, const Flags16&, const Flags16::TYPE))(&equal<Flags16>)),
        ...
        class_<Flags32>("flags32")
            ...
            .def("and",
                 (Flags32 & (Flags32::*)(const Flags32&, const Flags32::TYPE))(&Flags32::and))
            .def("set", &set<Flags32>)
            .def("is", &is<Flags32>)
            ...
            .def("equal",
                 (bool (*)(Flags32*, const Flags32&, const Flags32::TYPE))(&equal<Flags32>))];
}