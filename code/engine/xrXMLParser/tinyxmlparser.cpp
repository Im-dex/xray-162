...
const char* TiXmlDocument::Parse(TiXmlDocument*, const char* p, TiXmlParsingData* prevData,
                                 TiXmlEncoding encoding) {
    ClearError();
...
const char* TiXmlElement::Parse(TiXmlDocument* document, const char* p, TiXmlParsingData* data,
                                TiXmlEncoding encoding) {
    p = SkipWhiteSpace(p, encoding);
...
const char* TiXmlUnknown::Parse(TiXmlDocument* document, const char* p, TiXmlParsingData* data,
                                TiXmlEncoding encoding) {
    p = SkipWhiteSpace(p, encoding);
...
const char* TiXmlComment::Parse(TiXmlDocument* document, const char* p, TiXmlParsingData* data,
                                TiXmlEncoding encoding) {
    value = "";
...
const char* TiXmlText::Parse(TiXmlDocument* document, const char* p, TiXmlParsingData* data,
                             TiXmlEncoding encoding) {
    value = "";
