...
void CBlender_fluid_advect::Compile(CBlender_Compile& C) {
    ...
    case 3: // AdvectBFECCTemp
        C.r_Pass("fluid_grid", "fluid_array", "fluid_advect_bfecc_temp", false, FALSE, FALSE,
                 FALSE);
        break;
    case 4: // AdvectVel
...
void CBlender_fluid_simulate::Compile(CBlender_Compile& C) {
    ...
    case 1: // Confinement
        ...
        C.r_Pass("fluid_grid", "fluid_array", "fluid_confinement", false, FALSE, FALSE, TRUE,
...
void CBlender_fluid_obst::Compile(CBlender_Compile& C) {
    ...
    case 0: // ObstStaticBox
        ...
        C.r_Pass("fluid_grid_oobb", "fluid_array_oobb", "fluid_obst_static_oobb", false, FALSE,
                 FALSE, FALSE);
        break;
    case 1: // ObstDynBox
        //	OOBB
        C.r_Pass("fluid_grid_dyn_oobb", "fluid_array_dyn_oobb", "fluid_obst_dynamic_oobb", false,
                 FALSE, FALSE, FALSE);
        break;
    }
...
void CBlender_fluid_emitter::Compile(CBlender_Compile& C) {
    ...
    case 0: // ET_SimpleGausian
        C.r_Pass("fluid_grid", "fluid_array", "fluid_gaussian", false, FALSE, FALSE, TRUE,
...
void CBlender_fluid_obstdraw::Compile(CBlender_Compile& C) {
    ...
    case 0: // DrawTexture
        ...
        break;
        //		TechniqueDrawWhiteTriangles = pEffect->GetTechniqueByName(
        //"DrawWhiteTriangles" );
...
void CBlender_fluid_raydata::Compile(CBlender_Compile& C) {
    ...
    case 1: // CompRayData_Front
        C.r_Pass("fluid_raydata_front", "null", "fluid_raydata_front", false, FALSE, FALSE, TRUE,
                 D3DBLEND_ONE, D3DBLEND_ONE);
    ...
    case 2: // QuadDownSampleRayDataTexture
        C.r_Pass("fluid_raycast_quad", "null", "fluid_raydatacopy_quad", false, FALSE, FALSE,
                 FALSE);
        C.r_CullMode(D3DCULL_CCW); //	Back
        break;
    }
...
void CBlender_fluid_raycast::Compile(CBlender_Compile& C) {
    ...
    case 2: // QuadRaycastCopyFog
        C.r_Pass("fluid_raycast_quad", "null", "fluid_raycastcopy_quad", false, FALSE, FALSE, TRUE,
                 D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA);
        C.r_ColorWriteEnable(true, true, true, false);
        C.r_CullMode(D3DCULL_CCW); //	Back
        break;
    case 3: // QuadRaycastFire
        C.r_Pass("fluid_raycast_quad", "null", "fluid_raycast_quad_fire", false, FALSE, FALSE,
                 FALSE);
        C.r_CullMode(D3DCULL_CCW); //	Back
        break;
    case 4: // QuadRaycastCopyFire
        C.r_Pass("fluid_raycast_quad", "null", "fluid_raycastcopy_quad_fire", false, FALSE, FALSE,
