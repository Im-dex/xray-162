...
void dx103DFluidManager::Initialize(int width, int height, int depth) {
    ...
    m_pObstaclesHandler =
        new dx103DFluidObstacles(m_iTextureWidth, m_iTextureHeight, m_iTextureDepth, m_pGrid);

    m_pEmittersHandler =
        new dx103DFluidEmitters(m_iTextureWidth, m_iTextureHeight, m_iTextureDepth, m_pGrid);
