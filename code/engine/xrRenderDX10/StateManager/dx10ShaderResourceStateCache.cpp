...
void dx10ShaderResourceStateCache::Apply() {
    if (m_bUpdatePSViews) {
        HW.pContext->PSSetShaderResources(m_uiMinPSView, m_uiMaxPSView - m_uiMinPSView + 1,
    ...
    if (m_bUpdateGSViews) {
        HW.pContext->GSSetShaderResources(m_uiMinGSView, m_uiMaxGSView - m_uiMinGSView + 1,
    ...
    if (m_bUpdateVSViews) {
        HW.pContext->VSSetShaderResources(m_uiMinVSView, m_uiMaxVSView - m_uiMinVSView + 1,
...
#ifdef USE_DX11
    if (m_bUpdateHSViews) {
        HW.pContext->HSSetShaderResources(m_uiMinHSView, m_uiMaxHSView - m_uiMinHSView + 1,
    ...
    if (m_bUpdateDSViews) {
        HW.pContext->DSSetShaderResources(m_uiMinDSView, m_uiMaxDSView - m_uiMinDSView + 1,
    ...
    if (m_bUpdateCSViews) {
        HW.pContext->CSSetShaderResources(m_uiMinCSView, m_uiMaxCSView - m_uiMinCSView + 1,
