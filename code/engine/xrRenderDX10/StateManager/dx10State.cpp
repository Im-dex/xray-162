...
dx10State::dx10State()
    : m_pRasterizerState(0), m_pDepthStencilState(0), m_pBlendState(0), m_uiStencilRef(UINT(-1)),
      m_uiAlphaRef(0) {}
...
void dx10State::InitSamplers(tSamplerHArray& SamplerArray, SimulatorStates& state_code,
