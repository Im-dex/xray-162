...
public:
    ...
    IC void play_no_feedback(CObject* O, u32 flags = 0, float delay = 0.f, Fvector* pos = 0,
...
public:
    ...
    virtual void clone(ref_sound& S, const ref_sound& from, esound_type sound_type,
                       int game_type) = 0;
...
IC void ref_sound::play_no_feedback(CObject* O, u32 flags, float d, Fvector* pos, float* vol,
