...
TEMPLATE_SPECIALIZATION
inline buffer_vector_specialized::buffer_vector(void* buffer, size_type const& max_count,
                                                size_type const& count, value_type const& value)
    : m_begin((T*)buffer), m_end((T*)buffer), m_max_end((T*)buffer + max_count) {
    assign(count, value);
}
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::self_type& buffer_vector_specialized::
operator=(self_type const& other) {
    assign(other.begin(), other.end());
}
...
TEMPLATE_SPECIALIZATION
template <typename input_iterator>
inline void buffer_vector_specialized::insert(iterator const& where, input_iterator begin,
                                              input_iterator const& end) {
...
TEMPLATE_SPECIALIZATION
inline void buffer_vector_specialized::insert(iterator const& where, size_type const& count,
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::reference buffer_vector_specialized::
...
TEMPLATE_SPECIALIZATION
inline typename buffer_vector_specialized::const_reference buffer_vector_specialized::
