...
LPSTR _GetItem(LPCSTR src, int index, LPSTR dst, u32 const dst_size, char separator, LPCSTR def,
               bool trim) {
    LPCSTR ptr;
...
LPSTR _ReplaceItems(LPCSTR src, int idx_start, int idx_end, LPCSTR new_items, LPSTR dst,
                    char separator) {
    LPSTR n = dst;
    int level = 0;
    bool bCopy = true;
...
AnsiString& _ReplaceItems(LPCSTR src, int idx_start, int idx_end, LPCSTR new_items, AnsiString& dst,
                          char separator) {
    dst = "";
    int level = 0;
    bool bCopy = true;
