...
//used. 				  * MakeDelegate() global helper function added to simplify
//pass-by-value. 				  * Added fastdelegate.clear()
...
//Dlugosz: 				     - The FASTDELEGATEDECLARE workaround is no longer
//necessary. 					 - No more warning messages for VC6
//				  * Less use of macros. Error messages should be more
//comprehensible. 				  * Added include guards
//				  * Added FastDelegate::empty() to test if invocation is safe (Thanks
//Neville Franks). 				  * Now tested on VS 2005 Express Beta, PGI C++
...
//class. 				  * Standardised all the compiler-specific workarounds.
...
// 14-Feb-05 1.4.1* Now treats =0 as equivalent to .clear(), ==0 as equivalent to .empty(). (Thanks
// elfric).
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3 * sizeof(int)> {
    ...
    inline static GenericClass* xr_stdcall Convert(X* pthis, XFuncType function_to_bind,
        ...
        if (u.s.vtable_index) { // Virtual inheritance is used
            ...
            virtual_delta =
                u.s.vtordisp + *reinterpret_cast<const int*>(reinterpret_cast<const char*>(vtable) +
                                                             u.s.vtable_index);
        }
...
public:
    ...
    inline void bindmemfunc(X* pthis, XMemFunc function_to_bind) {
        m_pthis = SimplifyMemFunc<sizeof(function_to_bind)>::Convert(pthis, function_to_bind,
                                                                     m_pFunction);
#if !defined(FASTDELEGATE_USESTATICFUNCTIONHACK)
        m_pStaticFunction = 0;
#endif
    ...
    inline void bindconstmemfunc(const X* pthis, XMemFunc function_to_bind) {
        m_pthis = SimplifyMemFunc<sizeof(function_to_bind)>::Convert(const_cast<X*>(pthis),
...
public:
    ...
    inline void bindstaticfunc(DerivedClass* pParent, ParentInvokerSig static_function_invoker,
        ...
        typedef int
            ERROR_CantUseEvilMethod[sizeof(GenericClass*) == sizeof(function_to_bind) ? 1 : -1];
    ...
    inline bool IsEqualToStaticFuncPtr(StaticFuncPtr funcptr) {
        if (funcptr == 0)
            return empty();
        // For the Evil method, if it doesn't actually contain a static function, this will return
        // an arbitrary value that is not equal to any valid function pointer.
        else
...
private:
    ...
    typedef detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr>
        ClosureType;
...
public:
    ...
    FastDelegate1(const Y* pthis,
                  DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1) const) {
        m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
    }
    template <class X, class Y>
...
public:
    ...
    FastDelegate2(Y* pthis,
                  DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2)) {
        m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
    }
    template <class X, class Y>
    ...
    FastDelegate2(const Y* pthis,
                  DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2) const) {
        m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
    }
    template <class X, class Y>
    inline void bind(const Y* pthis,
...
public:
    ...
    // Binding to non-const member functions
    template <class X, class Y>
    FastDelegate3(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2,
                                                                             Param3 p3)) {
        m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
    }
    template <class X, class Y>
...
public:
    ...
    // Static functions. We convert them into a member function call.
    // This constructor also provides implicit conversion
    FastDelegate4(DesiredRetType(xr_stdcall* function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                               Param4 p4)) {
        bind(function_to_bind);
    }
    // for efficiency, prevent creation of a temporary
...
public:
    ...
    template <class X, class Y>
    inline void
    bind(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                                    Param4 p4, Param5 p5)) {
        m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
    }
    // Binding to const member functions.
    ...
    // Static functions. We convert them into a member function call.
    // This constructor also provides implicit conversion
    FastDelegate5(DesiredRetType(xr_stdcall* function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                               Param4 p4, Param5 p5)) {
        bind(function_to_bind);
    }
    // for efficiency, prevent creation of a temporary
...
private: // Invoker for static functions
    RetType xr_stdcall InvokeStaticFunction(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                            Param5 p5) const {
...
public:
    ...
    // Binding to non-const member functions
    template <class X, class Y>
    FastDelegate6(Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(
    ...
    // Static functions. We convert them into a member function call.
    // This constructor also provides implicit conversion
    FastDelegate6(DesiredRetType(xr_stdcall* function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                               Param4 p4, Param5 p5, Param6 p6)) {
        bind(function_to_bind);
    }
    // for efficiency, prevent creation of a temporary
...
private: // Invoker for static functions
    RetType xr_stdcall InvokeStaticFunction(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
                                            Param6 p6) const {
...
// N=7
template <class Param1, class Param2, class Param3, class Param4, class Param5, class Param6,
          class Param7, class RetType = detail::DefaultVoid>
class FastDelegate7 {
private:
    typedef typename detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
    typedef DesiredRetType(xr_stdcall* StaticFunctionPtr)(Param1 p1, Param2 p2, Param3 p3,
...
public:
    ...
    template <class X, class Y>
    inline void bind(const Y* pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(
    ...
    // Static functions. We convert them into a member function call.
    // This constructor also provides implicit conversion
    FastDelegate7(DesiredRetType(xr_stdcall* function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                               Param4 p4, Param5 p5, Param6 p6,
                                                               Param7 p7)) {
        bind(function_to_bind);
    }
    ...
    // Invoke the delegate
    RetType operator()(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6,
                       Param7 p7) const {
...
// N=8
template <class Param1, class Param2, class Param3, class Param4, class Param5, class Param6,
          class Param7, class Param8, class RetType = detail::DefaultVoid>
class FastDelegate8 {
private:
    typedef typename detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
    typedef DesiredRetType(xr_stdcall* StaticFunctionPtr)(Param1 p1, Param2 p2, Param3 p3,
...
public:
    ...
    // Static functions. We convert them into a member function call.
    // This constructor also provides implicit conversion
    FastDelegate8(DesiredRetType(xr_stdcall* function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                               Param4 p4, Param5 p5, Param6 p6,
                                                               Param7 p7, Param8 p8)) {
        bind(function_to_bind);
    }
    ...
    // Invoke the delegate
    RetType operator()(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7,
                       Param8 p8) const {
        return (m_Closure.GetClosureThis()->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3, p4, p5, p6,
                                                                             p7, p8);
    }
...
public:
    ...
    template <class X, class Y>
    FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)())
        : BaseType(pthis, function_to_bind) {}

    template <class X, class Y>
    FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)() const)
        : BaseType(pthis, function_to_bind) {}
...
public:
    ...
    template <class X, class Y>
    FastDelegate(Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1))
        : BaseType(pthis, function_to_bind) {}
...
public:
    ...
    template <class X, class Y>
    FastDelegate(const Y* pthis, R (xr_stdcall X::*function_to_bind)(Param1 p1, Param2 p2,
                                                                     Param3 p3, Param4 p4) const)
        : BaseType(pthis, function_to_bind) {}
...
public:
    // Make using the base type a bit easier via typedef.
    typedef FastDelegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, R>
        BaseType;
...
FastDelegate1<Param1, FASTDLGT_RETTYPE> MakeDelegate(Y* x,
                                                     RetType (xr_stdcall X::*func)(Param1 p1)) {
...
FastDelegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>
MakeDelegate(Y* x,
             RetType (xr_stdcall X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) {
    return FastDelegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}
...
MakeDelegate(Y* x,
             RetType (xr_stdcall X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
...
MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
                                      Param6 p6, Param7 p7)) {
    return FastDelegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(
        x, func);
}
...
MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
    ...
    return FastDelegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8,
