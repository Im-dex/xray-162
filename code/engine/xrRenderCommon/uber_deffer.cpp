...
void uber_deffer(CBlender_Compile& C, bool hq, LPCSTR _vspec, LPCSTR _pspec, BOOL _aref,
    ...
    xr_strcpy(dt, sizeof(dt),
              _detail_replace ? _detail_replace : (C.detail_texture ? C.detail_texture : ""));
...
// Uber-construct
    ...
    // D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC);	// should be before base
    // bump  C.r_Sampler		("s_bump",		fnameA,				false,
    // D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,	D3DTEXF_ANISOTROPIC);  C.r_Sampler
    // ("s_bumpD",		dt,					false,	D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
    // D3DTEXF_ANISOTROPIC);
    ...
    C.r_Sampler("s_base", C.L_textures[0], false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
    ...
    C.r_Sampler("s_bump", fnameA, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                D3DTEXF_ANISOTROPIC);
    C.r_Sampler("s_bumpD", dt, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                D3DTEXF_ANISOTROPIC);
    C.r_Sampler("s_detail", dt, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR,
                D3DTEXF_ANISOTROPIC);
    if (bHasDetailBump) {
        C.r_Sampler("s_detailBump", texDetailBump, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
                    D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
        C.r_Sampler("s_detailBumpX", texDetailBumpX, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
                    D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
    }
    if (lmap)
        C.r_Sampler("s_hemi", C.L_textures[2], false, D3DTADDRESS_CLAMP, D3DTEXF_LINEAR,
