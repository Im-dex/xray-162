...
void NvStripifier::FindAllStrips(NvStripInfoVec& allStrips, NvFaceInfoVec& allFaceInfos,
    ...
    while (!done) {
        ...
        for (i = 0; i < numSamples; i++) {
            ...
            NvStripInfo* strip01 = new NvStripInfo(NvStripStartInfo(nextFace, edge01, true),
            ...
            NvStripInfo* strip10 = new NvStripInfo(NvStripStartInfo(nextFace, edge10, false),
                                                       stripId++, experimentId++);
            ...
            NvStripInfo* strip12 = new NvStripInfo(NvStripStartInfo(nextFace, edge12, true),
                                                       stripId++, experimentId++);
            ...
            NvStripInfo* strip21 = new NvStripInfo(NvStripStartInfo(nextFace, edge21, false),
                                                       stripId++, experimentId++);
            ...
            NvStripInfo* strip20 = new NvStripInfo(NvStripStartInfo(nextFace, edge20, true),
                                                       stripId++, experimentId++);
            ...
            NvStripInfo* strip02 = new NvStripInfo(NvStripStartInfo(nextFace, edge02, false),
                                                       stripId++, experimentId++);
