...
void CBlender_Model::Compile(CBlender_Compile& C) {
    ...
    if (C.bEditor) {
        ...
        case SE_R1_NORMAL_HQ:
            ...
            if (oBlend.value)
                C.r_Pass(vsname, psname, TRUE, TRUE, TRUE, TRUE, D3DBLEND_SRCALPHA,
        ...
        case SE_R1_LPOINT:
            ...
            if (oBlend.value)
                ...
                C.r_Pass(vsname, psname, FALSE, TRUE, FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE,
                         TRUE);
            C.r_Sampler("s_base", C.L_textures[0]);
        ...
        case SE_R1_LMODELS:
            ...
            psname = "model_shadow";
            C.r_Pass(vsname, psname, FALSE, FALSE, FALSE, TRUE, D3DBLEND_ZERO, D3DBLEND_SRCCOLOR,
                     FALSE, 0);
            C.r_End();
            break;
        }
