...
IC CPhysicsJoint* CtreateHinge(const IBoneData& bone_data, u8 limit_num, CPhysicsElement* root_e,
                               CPhysicsElement* E) {
    u8 axis_num = 0;
...
IC CPhysicsJoint* CtreateFullControl(const IBoneData& bone_data, u8 limit_num[3],
                                     CPhysicsElement* root_e, CPhysicsElement* E) {
...
IC CPhysicsJoint* BuildWheelJoint(const IBoneData& bone_data, CPhysicsElement* root_e,
                                  CPhysicsElement* E) {
    const SJointIKData& joint_data = bone_data.get_IK_data();
...
IC CPhysicsJoint* BuildSliderJoint(const IBoneData& bone_data, CPhysicsElement* root_e,
                                   CPhysicsElement* E) {
    const SJointIKData& joint_data = bone_data.get_IK_data();
...
IC CPhysicsJoint* BuildBallJoint(const IBoneData& bone_data, CPhysicsElement* root_e,
                                 CPhysicsElement* E) {
    const SJointIKData& joint_data = bone_data.get_IK_data();
...
IC CPhysicsJoint* BuildGenericJoint(const IBoneData& bone_data, CPhysicsElement* root_e,
                                    CPhysicsElement* E) {
    const SJointIKData& joint_data = bone_data.get_IK_data();
...
IC CPhysicsJoint* BuildJoint(const IBoneData& bone_data, CPhysicsElement* root_e,
                             CPhysicsElement* E) {
    CPhysicsJoint* J = 0;
    const SJointIKData& joint_data = bone_data.get_IK_data();
