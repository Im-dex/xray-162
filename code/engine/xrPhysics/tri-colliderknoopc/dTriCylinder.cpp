...
bool dcTriListCollider::circleLineIntersection(const dReal* cn, const dReal* cp, dReal r,
                                               const dReal* lv, const dReal* lp, dReal sign,
                                               dVector3 point) {
...
int dcTriListCollider::dSortedTriCyl(const dReal* triSideAx0, const dReal* triSideAx1,
                                     const dReal* triAx,
                                     // const dReal* v0,
                                     // const dReal* v1,
                                     // const dReal* v2,
    ...
    if (code == 0) {
        ...
        if (dFabs(Q2) > M_SQRT1_2) {
            ...
            CONTACT(contact, ret * skip)->pos[0] =
                contact->pos[0] - 2.f * (A2 > 0 ? hlz * R[1] : -hlz * R[1]);
            CONTACT(contact, ret * skip)->pos[1] =
                contact->pos[1] - 2.f * (A2 > 0 ? hlz * R[5] : -hlz * R[5]);
            CONTACT(contact, ret * skip)->pos[2] =
                contact->pos[2] - 2.f * (A2 > 0 ? hlz * R[9] : -hlz * R[9]);
...
IC bool dcTriListCollider::cylinderCrossesLine(const dReal* p, const dReal* R, dReal hlz,
                                               const dReal* v0, const dReal* v1, const dReal* l,
                                               dVector3 pos) {
...
int dcTriListCollider::dTriCyl(const dReal* v0, const dReal* v1, const dReal* v2, Triangle* T,
    ...
    dVector3 triSideAx0 = { T->side0[0], T->side0[1],
                            T->side0[2] }; //{v1[0]-v0[0],v1[1]-v0[1],v1[2]-v0[2]};
    dVector3 triSideAx1 = { T->side1[0], T->side1[1],
...
#undef TEST
    ...
    if (code == 0) {
        ...
        if (dFabs(Q2) > M_SQRT1_2) {
            ...
            CONTACT(contact, ret * skip)->pos[0] =
                contact->pos[0] - 2.f * (Q2 > 0 ? hlz * R[1] : -hlz * R[1]);
            CONTACT(contact, ret * skip)->pos[1] =
                contact->pos[1] - 2.f * (Q2 > 0 ? hlz * R[5] : -hlz * R[5]);
            CONTACT(contact, ret * skip)->pos[2] =
                contact->pos[2] - 2.f * (Q2 > 0 ? hlz * R[9] : -hlz * R[9]);
