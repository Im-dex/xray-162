...
IC void dcTriListCollider::CrossProjLine(const dReal* pt1, const dReal* vc1, const dReal* pt2,
                                         const dReal* vc2, dReal* proj) {
...
IC void dcTriListCollider::CrossProjLine1(const dReal* pt1, const dReal* vc1, const dReal* pt2,
                                          const dReal* vc2, dReal* proj) {
    dVector3 ac = { pt1[0] - pt2[0], pt1[1] - pt2[1], pt1[2] - pt2[2] };
...
IC bool dcTriListCollider::CrossProjLine14(const dReal* pt1, const dReal* vc1, const dReal* pt2,
                                           const dReal* vc2, dReal hside, dReal* proj) {
    dVector3 ac = { pt1[0] - pt2[0], pt1[1] - pt2[1], pt1[2] - pt2[2] };
...
// is point in Box
IC bool dcTriListCollider::IsPtInBx(const dReal* Pt, const dReal* BxP, const dReal* BxEx,
                                    const dReal* BxR) {
    dVector3 BxPR, PtR;
...
inline dReal PointBoxTest(const dReal* Pt, const dReal* BxP, const dReal* BxEx, const dReal* R,
                          dReal* norm) {
    dVector3 BxPR, PtR;
...
IC dReal dcTriListCollider::FragmentonBoxTest(const dReal* Pt1, const dReal* Pt2, const dReal* BxP,
                                              const dReal* BxEx, const dReal* R, dReal* norm,
                                              dReal* pos) {
...
/*
inline dReal FragmentonBoxTest1(const dReal* Pt1,const dReal* Pt2,const dReal* BxP,const dReal*
BxEx,const dReal* R,dReal* norm){
