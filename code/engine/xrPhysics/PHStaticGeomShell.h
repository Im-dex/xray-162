...
class CPHStaticGeomShell : public CPHGeometryOwner,
    ...
    virtual void InitContact(dContact* c, bool& do_collide, u16 /*material_idx_1*/,
                             u16 /*material_idx_2*/) {}
...
// CPHStaticGeomShell* P_BuildStaticGeomShell(CGameObject* obj,ObjectContactCallbackFun*
// object_contact_callback);  CPHStaticGeomShell* P_BuildStaticGeomShell(CGameObject*
// obj,ObjectContactCallbackFun* object_contact_callback,Fobb &b);  void
// P_BuildStaticGeomShell(CPHStaticGeomShell* shell,CGameObject* obj,ObjectContactCallbackFun*
