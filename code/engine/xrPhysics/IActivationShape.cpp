...
void ActivateShapeExplosive(IPhysicsShellHolder* self_obj, const Fvector& size, Fvector& out_size,
                            Fvector& in_out_pos) {
    //////////////
    CPHActivationShape
        activation_shape; // Fvector start_box;m_PhysicMovementControl.Box().getsize(start_box);
...
void ActivateShapePhysShellHolder(IPhysicsShellHolder* obj, const Fmatrix& in_xform,
...
bool ActivateShapeCharacterPhysicsSupport(Fvector& out_pos, const Fvector& vbox,
