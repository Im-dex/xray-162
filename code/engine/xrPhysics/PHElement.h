...
class CPHElement : public CPhysicsElement,
    ...
    ////st 	dQuaternion					m_safe_quaternion; 	dVector3
...
public:
    ...
    virtual void set_ObjectContactCallback(
        ObjectContactCallbackFun* callback); // called anywhere ph state influent
...
public:                                                                 //
    ...
    virtual void add_Mass(const SBoneShape& shape, const Fmatrix& offset,
                          const Fvector& mass_center, float mass,
...
public:                      //
    ...
    // void						BoneGlPos								(Fmatrix &m, const CBoneInstance*
    // B)const;
