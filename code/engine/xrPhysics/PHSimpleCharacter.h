...
private:
    ...
    static void TestRestrictorContactCallbackFun(bool& do_colide, bool bo1, dContact& c,
...
public:
    ...
    // virtual		void		CaptureObject						(dBodyID body,const dReal*
    // anchor);
    // virtual		void		CapturedSetPosition					(const dReal*
