...
IC void cmp_matrix(bool& eq_linear, bool& eq_angular, const Fmatrix& m0, const Fmatrix& m1,
                   float tl, float ta) {
    float l, a;
...
IC void angular_diff(Fvector& aw, const Fmatrix& diff, float dt) {
    aw.set((diff._32 - diff._23) / 2.f / dt, (diff._13 - diff._31) / 2.f / dt,
