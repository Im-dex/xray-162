...
void line_edit_control::init(u32 str_buffer_size, init_mode mode) {
    ...
    if (mode == im_read_only) {
        ...
        assign_callback(DIK_RIGHT, ks_Ctrl,
        ...
        assign_callback(DIK_INSERT, ks_Ctrl, Callback(this, &line_edit_control::copy_to_clipboard));
        assign_callback(DIK_INSERT, ks_Shift,
        ...
        assign_callback(DIK_BACK, ks_free,
                        Callback(this, &line_edit_control::delete_selected_back));
        assign_callback(DIK_DELETE, ks_free,
        ...
        assign_callback(DIK_DELETE, ks_Ctrl,
...
void line_edit_control::add_inserted_text() {
    ...
    strncpy_s(buf + m_p1, m_buffer_size, m_inserted,
              std::min(new_size, m_buffer_size - m_p1)); // part 2
