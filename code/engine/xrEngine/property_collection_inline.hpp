...
SPECIALIZATION
inline PROPERTY_COLLECTION::property_collection(container_type* container, holder_type* holder,
                                                bool* changed)
...
SPECIALIZATION
inline bool PROPERTY_COLLECTION::predicate::
...
bool PROPERTY_COLLECTION::unique_id(LPCSTR id) const {
    return (std::find_if(m_container.begin(), m_container.end(), unique_id_predicate(id)) ==
            m_container.end());
}
