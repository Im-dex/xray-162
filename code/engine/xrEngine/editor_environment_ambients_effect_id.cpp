...
effect_id::effect_id(manager const& manager, shared_str const& id)
...
void effect_id::fill(editor::property_holder_collection* collection) {
    ...
    m_property_holder->add_property("effect", "properties", "this option is resposible for effect",
                                    m_id.c_str(), m_id, collection_getter, collection_size_getter,
