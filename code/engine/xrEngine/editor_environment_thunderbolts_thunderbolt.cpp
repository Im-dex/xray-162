...
void thunderbolt::fill(::editor::environment::manager& environment,
    ...
    m_property_holder->add_property("id", "properties",
                                    "this option is resposible for thunderbolt id", m_id.c_str(),
    ...
    m_property_holder->add_property(
        ...
        environment.light_animator_ids().size(), editor::property_holder::value_editor_tree_view,
    ...
    m_property_holder->add_property(
        "sound", "properties", "this option is resposible for thunderbolt sound", m_sound.c_str(),
        m_sound, ".ogg", "Sound files (*.ogg)|*.ogg",
    ...
    m_center->fill(environment, "center",
                   "this option is resposible for thunderbolt gradient center", *m_property_holder);
    m_top->fill(environment, "top", "this option is resposible for thunderbolt gradient top",
                *m_property_holder);
}
