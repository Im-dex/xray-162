...
manager::manager()
    : m_suns(0), m_levels(0), m_effects(0), m_sound_channels(0), m_ambients(0), m_thunderbolts(0),
      m_weathers(0) {
...
void manager::create_mixer() {
    VERIFY(!CurrentEnv);
    editor::environment::weathers::time* object = xr_new<editor::environment::weathers::time>(
        this, (editor::environment::weathers::weather const*)0, "");
    CurrentEnv = object;
    object->fill(0);
}
...
SThunderboltCollection* manager::thunderbolt_collection(CInifile* pIni, CInifile* thunderbolts,
                                                        LPCSTR section) {
