...
void sun::fill(editor::property_holder_collection* collection) {
    ...
    properties->add_property("id", "common", "this option is resposible for sun identifier",
    ...
    properties->add_property("ignore color", "sun",
                             "this option is resposible for sun ignore color", m_ignore_color,
                             m_ignore_color);
    properties->add_property("radius", "sun", "this option is resposible for sun radius", m_radius,
                             m_radius);
    ...
    properties->add_property("texture", "sun", "this option is resposible for sun texture",
