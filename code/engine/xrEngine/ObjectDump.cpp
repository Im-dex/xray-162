...
/*
                struct
                {
                        ...
                        u32
dbg_update_cl; #endif u32
dwFrame_UpdateCL; u32
dwFrame_AsCrow;
*/
ENGINE_API std::string dbg_object_props_dump_string(const CObject* obj) {
    ...
    return make_string(
           ...
           make_string("\n dbg_update_cl: %d, dwFrame_UpdateCL: %d, dwFrame_AsCrow :%d, "
                       "Device.dwFrame :%d, Device.dwTimeGlobal: %d  \n",
...
ENGINE_API std::string dbg_object_full_dump_string(const CObject* obj) {
    return dbg_object_base_dump_string(obj) + dbg_object_props_dump_string(obj) +
           dbg_object_poses_dump_string(obj) + dbg_object_visual_geom_dump_string(obj);
}
