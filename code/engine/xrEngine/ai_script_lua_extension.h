...
bool bfLoadFileIntoNamespace(CLuaVirtualMachine* tpLuaVM, LPCSTR caScriptName,
...
bool bfIsObjectPresent(CLuaVirtualMachine* tpLuaVM, LPCSTR caNamespaceName, LPCSTR caIdentifier,
                       int type);
