...
static int _lzo1a_do_compress(const lzo_byte* in, lzo_uint in_len, lzo_byte* out, lzo_uintp out_len,
...
LZO_PUBLIC(int)
LZO_COMPRESS(const lzo_byte* in, lzo_uint in_len, lzo_byte* out, lzo_uintp out_len,
             lzo_voidp wrkmem) {
