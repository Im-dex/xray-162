...
LZO_PUBLIC(lzo_bool)
lzo_assert(int expr) { return (expr) ? 1 : 0; }
...
#endif
                                                     " $\n"
                                                     "$Copyright: LZO (C) 1996, 1997, 1998, 1999, "
                                                     "2000, 2001, 2002 Markus Franz Xaver Johannes "
                                                     "Oberhumer $\n";
#endif
...
LZO_PUBLIC(unsigned)
lzo_version(void) { return LZO_VERSION; }

LZO_PUBLIC(const char*)
lzo_version_string(void) { return LZO_VERSION_STRING; }

LZO_PUBLIC(const char*)
lzo_version_date(void) { return LZO_VERSION_DATE; }

LZO_PUBLIC(const lzo_charp)
_lzo_version_string(void) { return LZO_VERSION_STRING; }

LZO_PUBLIC(const lzo_charp)
_lzo_version_date(void) { return LZO_VERSION_DATE; }
