...
int _lzo1b_do_compress(const lzo_byte* in, lzo_uint in_len, lzo_byte* out, lzo_uintp out_len,
    ...
    lzo_stats->match_bytes = 1 * lzo_stats->m1_matches + 2 * lzo_stats->m2_matches +
...
void _lzo1b_stats_init(lzo_stats_t* lzo_stats) { memset(lzo_stats, 0, sizeof(*lzo_stats)); }

void _lzo1b_stats_calc(lzo_stats_t* lzo_stats) {
    lzo_stats->matches = lzo_stats->m1_matches + lzo_stats->m2_matches + lzo_stats->m3_matches +
                         lzo_stats->m4_matches;

    lzo_stats->literal_overhead =
        lzo_stats->lit_runs +
        2 * (lzo_stats->r0short_runs + lzo_stats->r0fast_runs + lzo_stats->r0long_runs);
