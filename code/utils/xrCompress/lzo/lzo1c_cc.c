...
int _lzo1c_do_compress(const lzo_byte* in, lzo_uint in_len, lzo_byte* out, lzo_uintp out_len,
...
void _lzo1c_stats_init(lzo_stats_t* lzo_stats) { memset(lzo_stats, 0, sizeof(*lzo_stats)); }
