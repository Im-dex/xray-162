...
typedef int(__LZO_ENTRY* lzo_compress_t)(const lzo_byte* src, lzo_uint src_len, lzo_byte* dst,
                                         lzo_uintp dst_len, lzo_voidp wrkmem);

typedef int(__LZO_ENTRY* lzo_decompress_t)(const lzo_byte* src, lzo_uint src_len, lzo_byte* dst,
                                           lzo_uintp dst_len, lzo_voidp wrkmem);

typedef int(__LZO_ENTRY* lzo_optimize_t)(lzo_byte* src, lzo_uint src_len, lzo_byte* dst,
                                         lzo_uintp dst_len, lzo_voidp wrkmem);
...
#define lzo_init()                                                                      \
    __lzo_init2(LZO_VERSION, (int)sizeof(short), (int)sizeof(int), (int)sizeof(long),   \
                ...
                (int)sizeof(char*), (int)sizeof(lzo_voidp), (int)sizeof(lzo_compress_t))
