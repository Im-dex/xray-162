...
typedef bool(__cdecl TTaskProc)(DWORD sessionId, IGenericStream* inStream,
...
DECLARE_INTERFACE_(IGridUser, IUnknown) {
    ...
    virtual HRESULT __stdcall RunTask(IN const char* moduleName, IN const char* taskProcName,
                                      IGenericStream* inStream, TFinalizeProc* finalizeProc,
                                      OUT DWORD* taskId, bool blocking = true) = 0;
