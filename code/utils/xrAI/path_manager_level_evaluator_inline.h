...
#define CLevelEvaluatorPathManager                                                             \
    CPathManager<CLevelGraph, _DataStorage, CAbstractVertexEvaluator, _dist_type, _index_type, \
                 _iteration_type\
>
...
TEMPLATE_SPECIALIZATION
IC void CLevelEvaluatorPathManager::setup(const _Graph* _graph, _DataStorage* _data_storage,
