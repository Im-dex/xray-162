...
IC bool TestRayTri(const Fvector& C, const Fvector& D, Fvector** p, float& u, float& v,
                   float& range, bool bCull) {
...
IC bool TestRayTri(const Fvector& C, const Fvector& D, Fvector* p, float& u, float& v, float& range,
                   bool bCull) {
    Fvector edge1, edge2, tvec, pvec, qvec;
    float det, inv_det;
    // find vectors for two edges sharing vert0
...
IC bool TestBBoxTri(const Fmatrix33& A, const Fvector& T, const Fvector& extA, Fvector** p,
                    BOOL bCulling) {
...
//----------------------------------------------------------------------------
IC float MgcSqrDistance(const Fvector& rkPoint, const Fvector& orig, const Fvector& e0,
                        const Fvector& e1) {
...
IC EST_Result TestSphereTri(const Fvector& sphereOrigin, float sphereRadius, const Fvector& orig,
                            const Fvector& e0, const Fvector& e1) {
