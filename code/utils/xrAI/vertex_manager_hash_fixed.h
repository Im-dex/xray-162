...
struct CVertexManagerHashFixed {
    ...
    class CDataStorage
        : public _data_storage::template CDataStorage<VertexManager<_vertex>::_vertex> {
    public:
        typedef typename _data_storage::template CDataStorage<VertexManager<_vertex>::_vertex>
            inherited;
...
#pragma pack(pop)
    ...
    public:
        ...
        static IC void add_opened(CGraphVertex& vertex);
