...
#define CLevelFlooderPathManager                                                                \
    CPathManager<CLevelGraph, _DataStorage, SFlooder<_dist_type, _index_type, _iteration_type>, \
...
TEMPLATE_SPECIALIZATION
IC _dist_type CLevelFlooderPathManager::evaluate(const _index_type& node_index1,
