...
protected:
    ...
    //			void						add_spawn_group						(CSE_Abstract
    //*abstract);
    ...
    //	IC		void						normalize_probability				(CSE_ALifeAnomalousZone
    //*zone); 	IC		void						free_group_objects
    //();
...
public:
    IC CLevelSpawnConstructor(const CGameGraph::SLevel& level,
