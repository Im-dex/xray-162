...
IC bool operator==(intrusive_ptr<object_type, base_type> const& a,
                   intrusive_ptr<object_type, base_type> const& b);
...
template <typename object_type, typename base_type>
IC void swap(intrusive_ptr<object_type, base_type>& lhs,
