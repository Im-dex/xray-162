...
#define DlinkMethods(classname, linkname)                                        \
    ...
    classname* linkname##FindLast(void) {                                        \
        ...
        while (pCurr->linkname##pNextItem != NULL) {                             \
            VERIFY((pCurr->linkname##pPrevItem == NULL) ||                       \
                   (pCurr->linkname##pPrevItem->linkname##pNextItem == pCurr));  \
            VERIFY((pCurr->linkname##pNextItem == NULL) ||                       \
                   (pCurr->linkname##pNextItem->linkname##pPrevItem == pCurr));  \
