...
struct GeneralCollapseInfo {
    ...
    ArbitraryList<GeneralTriInfo> TriNextLevel; // On collapses that change levels, lists the tris
                                                // that were on the next level.
...
public:
    ...
    float FindCollapseError(MeshPt* pptBinned, MeshEdge* pedgeCollapse,
