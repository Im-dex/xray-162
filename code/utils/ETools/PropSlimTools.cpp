...
ETOOLS_API void __stdcall VIPM_AppendFace(u16 v0, u16 v1, u16 v2) {
    xr_new<MeshTri>(g_ppTempPts[v0], g_ppTempPts[v1], g_ppTempPts[v2], &g_pObject->CurTriRoot,
                    &g_pObject->CurEdgeRoot);
}

void CalculateAllCollapses(Object* m_pObject, u32 max_sliding_window = u32(-1),
...
ETOOLS_API VIPM_Result* __stdcall VIPM_Convert(u32 max_sliding_window, float error_tolerance,
                                               u32 optimize_vertex_order) {
