...
public:
    ...
    MeshTri(MeshPt* pNewPt1, MeshPt* pNewPt2, MeshPt* pNewPt3, MeshTri* pListRoot = NULL,
    ...
    bool ConsistencyCheck(MeshPt* pPtRoot = NULL, MeshEdge* pEdgeRoot = NULL,
                          MeshTri* pTriRoot = NULL);
...
public:
    ...
    // Try to merge these two edges. Result is TRUE if it succeeded - note that the other edge will
    // be NOT deleted.
...
inline MeshTri::MeshTri(MeshPt* pNewPt1, MeshPt* pNewPt2, MeshPt* pNewPt3, MeshTri* pListRoot,
                        MeshEdge* pEdgeListRoot) {
    VERIFY(pNewPt1 != NULL);
    VERIFY(pNewPt2 != NULL);
    VERIFY(pNewPt3 != NULL);
    pPt1 = pNewPt1;
...
// Try to merge these two edges. Result is TRUE if it succeeded - note that the other edge will be
// NOT deleted.
