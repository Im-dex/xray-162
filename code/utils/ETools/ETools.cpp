...
ETOOLS_API bool __stdcall TestRayTri2(const Fvector& C, const Fvector& D, Fvector* p,
                                      float& range) {
    Fvector edge1, edge2, tvec, pvec, qvec;
...
ETOOLS_API CDB::CollectorPacked* __stdcall create_collectorp(const Fbox& bb, int apx_vertices,
                                                             int apx_faces) {
