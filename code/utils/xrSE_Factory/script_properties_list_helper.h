...
public:
    ...
    ChooseValue* CreateChoose(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              u32 mode);
    ChooseValue* CreateChoose(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
    ...
    ChooseValue* CreateChoose(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              u32 mode, LPCSTR path, LPCSTR fill_param, u32 sub_item_cnt);

    //			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object object,
    //LPCSTR name);
    //			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object object,
    //LPCSTR name, s8 mn); 			S8Value* 			CreateS8
    //(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name, s8 mn, s8 mx);
    //			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object object,
    //LPCSTR name, s8 mn, s8 mx, s8 inc);
    ...
    BOOLValue* CreateBOOL(PropItemVec* items, LPCSTR key, luabind::object object,
                          luabind::object table, LPCSTR name);
    ...
    Flag8Value* CreateFlag8(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                            u8 mask);
    Flag8Value* CreateFlag8(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                            u8 mask, LPCSTR c0);
    Flag8Value* CreateFlag8(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                            u8 mask, LPCSTR c0, LPCSTR c1);
    Flag8Value* CreateFlag8(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                            u8 mask, LPCSTR c0, LPCSTR c1, u32 flags);

    Flag16Value* CreateFlag16(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              u16 mask);
    Flag16Value* CreateFlag16(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              u16 mask, LPCSTR c0);
    Flag16Value* CreateFlag16(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
    ...
    Flag32Value* CreateFlag32(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              u32 mask);
    Flag32Value* CreateFlag32(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              u32 mask, LPCSTR c0);
    Flag32Value* CreateFlag32(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
    ...
    Token32Value* CreateToken32(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                                CScriptTokenList* token);
    //			RToken8Value* 		CreateRToken8	    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, RTokenVec* token);
    //			RToken16Value* 		CreateRToken16	    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, RTokenVec* token);
    //			RToken32Value* 		CreateRToken32	    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, RTokenVec* token);
    //			TokenValueSH*   	CreateTokenSH	    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, u32 cnt, const TokenValueSH::Item* lst);
    ...
    //			WaveValue* 			CreateWave		    (PropItemVec* items, LPCSTR key, WaveForm*
    //val);
    ...
    VectorValue* CreateAngle3(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
                              float mn, float mx, float inc, int decim);
    //			RTextValue* 		CreateName		    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, ListItem* owner); 			RTextValue* 		CreateNameCB
    //(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name, TOnDrawTextEvent=0,
    //RTextValue::TOnBeforeEditEvent=0, RTextValue::TOnAfterEditEvent=0);
