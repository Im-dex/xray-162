...
void fill_mender_input(const vecOGF_V& vertices, const vecOGF_F& faces,
                       xr_vector<float>& i_position, xr_vector<float>& i_normal,
                       xr_vector<float>& i_tc, xr_vector<float>& i_color,
...
void retrive_data_from_mender_otput(vecOGF_V& vertices, vecOGF_F& faces,
                                    const xr_vector<float>& o_position,
                                    const xr_vector<float>& o_normal, const xr_vector<float>& o_tc,
...
void OGF::CalculateTB() {
    ...
    retrive_data_from_mender_otput(data.vertices, data.faces, o_position, o_normal, o_tc, o_tangent,
                                   o_binormal, o_color, o_indices);
}
