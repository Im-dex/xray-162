...
{
    std::memcpy(mat_array, array, sizeof(nv_scalar) * 9);
}

mat3::mat3(const mat3 & M)
{
    std::memcpy(mat_array, M.mat_array, sizeof(nv_scalar) * 9);
}
...
{
    std::memcpy(mat_array, array, sizeof(nv_scalar) * 16);
}

mat4::mat4(const mat4& M)
{
    std::memcpy(mat_array, M.mat_array, sizeof(nv_scalar) * 16);
}
