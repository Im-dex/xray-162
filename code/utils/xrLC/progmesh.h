...
PM_API void __cdecl PM_Init(u32 dwRelevantUV, u32 dwRelevantUVMASK, u32 dwMinVertCount,
                            float w_UV = 0.5f, float w_Pos = 1.f, float w_Norm = 1.f,
                            float p_BorderHeuristic = 150.f, float p_BorderHeuristicD = 0.07f,
