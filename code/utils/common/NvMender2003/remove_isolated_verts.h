...
static void add_face(const type_face& F, std::vector<type_vertex>& new_vertices,
                     std::vector<type_face>& new_faces, const std::vector<type_vertex>& vertices,
...
template <typename type_vertex, typename type_face>
static void
t_remove_isolated_verts(std::vector<type_vertex>& new_vertices, std::vector<type_face>& new_faces,
