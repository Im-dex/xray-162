...
template <class Vec>
inline typename Vec::value_type triangle_area(const Vec& v1, const Vec& v2, const Vec& v3) {
...
template <class Vec>
inline typename Vec::value_type triangle_compactness(const Vec& v1, const Vec& v2, const Vec& v3) {
