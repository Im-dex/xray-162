...
/*
   ...
   index of material
        u16						dwMaterialGame;		//
   unique-id of game material (must persist up to game-CForm saving)

                struct					{
                u16					bSplitted			:
   1; u16					bProcessed			:		1;
                u16					bOpaque				:
   1;	// For ray-tracing speedup
                u16					bLocked				:
   1;	// For tesselation }						flags;
*/
...
/*	Fvector					P;
        ...
        int						handle;		// used in
   mesh-processing/optimization/conversion
*/
