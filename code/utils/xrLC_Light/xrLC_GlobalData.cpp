...
// std::pair<u32,u32>			xrLC_GlobalData	::		get_id		( const _face *
// v ) const
//{
//	return ::get_id( _mu_models, v );
//}
//
// std::pair<u32,u32>			xrLC_GlobalData	::		get_id		( const _vertex
// * v ) const
//{
//	return ::get_id( _mu_models, v );
//}
enum serialize_mesh_item_type { smit_plain = u8(0), smit_model = u8(1), smit_null = u8(-1) };
