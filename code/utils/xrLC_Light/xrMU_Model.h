...
private:
    ...
    static void write_adjacents(IWriter& w, xrMU_Model::twrite_faces& write_faces,
                                const _vertex& v);
    ...
    static void write_face_verts(IWriter& w, xrMU_Model::twrite_vertices& write_verts,
                                 const _face& v);
};
