...
// public:
//	CMemoryReadBlock	( const u32	file_size_, u8*	&buff ):mem_reader(file_size_,
//buff ){};
//	virtual	void			r				( void *p, int cnt )const	{
//mem_reader.r(p,cnt); } 	virtual	u32				count
//()const						{ return mem_reader.count(); } 	virtual	void
//*pdata			()const						{ return mem_reader.pdata();
//}
//
//	void					free_buff		()const
//{ mem_reader.free_buff(); }
//	void					alloc			(u32 _file_size)const		{
//mem_reader.alloc(_file_size); } 	bool					allocated
//()const						{ return mem_reader.allocated(); } 	bool
//empty			()const						{ return mem_reader.empty();
//}
//};
