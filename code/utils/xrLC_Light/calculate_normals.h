...
private:
    typedef itterate_adjacents<itterate_adjacents_params_static<type_vertex>>
        itterate_adjacents_type;
...
public:
    static void calc_normals(vecVertex& vertices, vecFace& faces) {
        ...
        for (u32 I = 0; I < Vcount; I++) {
            ...
            for (vecAdjIt AFit = pTestVertex->m_adjacents.begin();
                 AFit != pTestVertex->m_adjacents.end(); ++AFit) {
                type_face* F = *AFit;
